# ResellerApiDocumentation.OrdersV4Api
...
let apiInstance = new ResellerApiDocumentation.OrdersV4Api();
let opts = {
...
let apiInstance = new ResellerApiDocumentation.OrdersV4Api();
let opts = {
  'orderModifyRequest': new ResellerApiDocumentation.OrderModifyRequest() // OrderModifyRequest | 
};
...
let apiInstance = new ResellerApiDocumentation.OrdersV4Api();
let opts = {
  'orderSearchRequest': new ResellerApiDocumentation.OrderSearchRequest() // OrderSearchRequest | 
};
