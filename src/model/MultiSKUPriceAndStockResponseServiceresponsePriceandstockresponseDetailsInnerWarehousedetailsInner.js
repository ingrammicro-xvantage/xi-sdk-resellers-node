 ...
 * @version 1.0.0
 */
class MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInnerWarehousedetailsInner {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('onholdquantity')) {
                obj['onholdquantity'] = ApiClient.convertToType(data['onholdquantity'], 'String');
            }
...
export default MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInnerWarehousedetailsInner;
