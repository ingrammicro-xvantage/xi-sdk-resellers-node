...
import QuoteCreateWebhookResponseResourceProductsInnerPrice from './QuoteCreateWebhookResponseResourceProductsInnerPrice';

/**
 * The QuoteCreateWebhookResponseResourceProductsInner model module.
 * @module model/QuoteCreateWebhookResponseResourceProductsInner
 * @version 1.0.0
 */
class QuoteCreateWebhookResponseResourceProductsInner {
    /**
     * Constructs a new <code>QuoteCreateWebhookResponseResourceProductsInner</code>.
     * @alias module:model/QuoteCreateWebhookResponseResourceProductsInner
     */
    constructor() { 
        
        QuoteCreateWebhookResponseResourceProductsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QuoteCreateWebhookResponseResourceProductsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QuoteCreateWebhookResponseResourceProductsInner} obj Optional instance to populate.
     * @return {module:model/QuoteCreateWebhookResponseResourceProductsInner} The populated <code>QuoteCreateWebhookResponseResourceProductsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QuoteCreateWebhookResponseResourceProductsInner();
            ...
            if (data.hasOwnProperty('price')) {
                obj['price'] = QuoteCreateWebhookResponseResourceProductsInnerPrice.constructFromObject(data['price']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>QuoteCreateWebhookResponseResourceProductsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QuoteCreateWebhookResponseResourceProductsInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['price']) { // data not null
          QuoteCreateWebhookResponseResourceProductsInnerPrice.validateJSON(data['price']);
        }
 ...
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['quoteProductGuid'] = undefined;
 ...
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['lineNumber'] = undefined;

/**
 * Quantity of product line item quoted.
 * @member {String} quantity
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['quantity'] = undefined;

/**
 * Product line item comments.
 * @member {String} notes
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['notes'] = undefined;

/**
 * EANUPC
 * @member {String} ean
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['ean'] = undefined;

/**
 * Country of Origin.
 * @member {String} coo
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['coo'] = undefined;
 ...
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['ingramPartNumber'] = undefined;

/**
 * Vendor Part Number
 * @member {String} vendorPartNumber
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['vendorPartNumber'] = undefined;
 ...
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['description'] = undefined;
 ...
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['weight'] = undefined;

/**
 * Unit of measure
 * @member {String} weightUom
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['weightUom'] = undefined;
 ...
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['isSuggestionProduct'] = undefined;

/**
 * Vendor product category specific to Cisco. HWDW (hardware) or service.
 * @member {String} vpnCategory
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['vpnCategory'] = undefined;

/**
 * Vendor product configuration ID specific to Cisco.
 * @member {String} quoteProductsSupplierPartAuxiliaryId
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['quoteProductsSupplierPartAuxiliaryId'] = undefined;

/**
 * Vendor name of the product
 * @member {String} vendorName
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['vendorName'] = undefined;

/**
 * Terms of the quote
 * @member {String} terms
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['terms'] = undefined;

/**
 * @member {module:model/QuoteCreateWebhookResponseResourceProductsInnerPrice} price
 */
QuoteCreateWebhookResponseResourceProductsInner.prototype['price'] = undefined;
...
export default QuoteCreateWebhookResponseResourceProductsInner;
