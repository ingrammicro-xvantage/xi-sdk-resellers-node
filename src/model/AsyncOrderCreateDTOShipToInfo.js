...
/**
 * The AsyncOrderCreateDTOShipToInfo model module.
 * @module model/AsyncOrderCreateDTOShipToInfo
 * @version 1.0.0
 */
class AsyncOrderCreateDTOShipToInfo {
    /**
     * Constructs a new <code>AsyncOrderCreateDTOShipToInfo</code>.
     * The shipping information provided by the reseller for order delivery.
     * @alias module:model/AsyncOrderCreateDTOShipToInfo
     */
    constructor() { 
        
        AsyncOrderCreateDTOShipToInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AsyncOrderCreateDTOShipToInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AsyncOrderCreateDTOShipToInfo} obj Optional instance to populate.
     * @return {module:model/AsyncOrderCreateDTOShipToInfo} The populated <code>AsyncOrderCreateDTOShipToInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AsyncOrderCreateDTOShipToInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>AsyncOrderCreateDTOShipToInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AsyncOrderCreateDTOShipToInfo</code>.
     */
 ...
 */
AsyncOrderCreateDTOShipToInfo.prototype['addressId'] = undefined;

/**
 * The contact name for the order will be shipped to.
 * @member {String} contact
 */
AsyncOrderCreateDTOShipToInfo.prototype['contact'] = undefined;

/**
 * The name of the company the order will be shipped to.
 * @member {String} companyName
 */
AsyncOrderCreateDTOShipToInfo.prototype['companyName'] = undefined;

/**
 * The address line 1 the order will be shipped to.
 * @member {String} addressLine1
 */
AsyncOrderCreateDTOShipToInfo.prototype['addressLine1'] = undefined;

/**
 * The address line 2 the order will be shipped to.
 * @member {String} addressLine2
 */
AsyncOrderCreateDTOShipToInfo.prototype['addressLine2'] = undefined;

/**
 * The address line 3 the order will be shipped to.
 * @member {String} addressLine3
 */
AsyncOrderCreateDTOShipToInfo.prototype['addressLine3'] = undefined;

/**
 * The address line 4 the order will be shipped to.
 * @member {String} addressLine4
 */
AsyncOrderCreateDTOShipToInfo.prototype['addressLine4'] = undefined;

/**
 * Need description
 * @member {String} name1
 */
AsyncOrderCreateDTOShipToInfo.prototype['name1'] = undefined;

/**
 * Need description
 * @member {String} name2
 */
AsyncOrderCreateDTOShipToInfo.prototype['name2'] = undefined;

/**
 * The city the order will be shipped to.
 * @member {String} city
 */
AsyncOrderCreateDTOShipToInfo.prototype['city'] = undefined;

/**
 * The state the order will be shipped to.
 * @member {String} state
 */
AsyncOrderCreateDTOShipToInfo.prototype['state'] = undefined;

/**
 * The zip or postal code the order will be shipped to.
 * @member {String} postalCode
 */
AsyncOrderCreateDTOShipToInfo.prototype['postalCode'] = undefined;

/**
 * The two-character ISO country code the order will be shipped to.
 * @member {String} countryCode
 */
AsyncOrderCreateDTOShipToInfo.prototype['countryCode'] = undefined;

/**
 * The company contact email address.
 * @member {String} email
 */
AsyncOrderCreateDTOShipToInfo.prototype['email'] = undefined;

/**
 * Shipping Notes
 * @member {String} shippingNotes
 */
AsyncOrderCreateDTOShipToInfo.prototype['shippingNotes'] = undefined;

/**
 * Phone number for shipping
 * @member {String} phoneNumber
 */
AsyncOrderCreateDTOShipToInfo.prototype['phoneNumber'] = undefined;
...
export default AsyncOrderCreateDTOShipToInfo;
