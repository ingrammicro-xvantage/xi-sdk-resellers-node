...
import InvoiceSearchResponseInvoicesInner from './InvoiceSearchResponseInvoicesInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('invoices')) {
                obj['invoices'] = ApiClient.convertToType(data['invoices'], [InvoiceSearchResponseInvoicesInner]);
            }
    ...
    static validateJSON(data) {
        if (data['invoices']) { // data not null
            ...
            for (const item of data['invoices']) {
                InvoiceSearchResponseInvoicesInner.validateJSON(item);
            };
        }
...
export default InvoiceSearchResponse;
