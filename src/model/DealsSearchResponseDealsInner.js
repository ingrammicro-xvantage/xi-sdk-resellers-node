...
class DealsSearchResponseDealsInner {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = RenewalsSearchResponseRenewalsInnerLinksInner.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['links']) { // data not null
          RenewalsSearchResponseRenewalsInnerLinksInner.validateJSON(data['links']);
        }
