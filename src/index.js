...
* <pre>
* var ResellerApiDocumentation = require('index'); // See note below*.
* var xxxSvc = new ResellerApiDocumentation.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ResellerApiDocumentation.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ResellerApiDocumentation.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ResellerApiDocumentation.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
