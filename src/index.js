...
* <pre>
* var ResellerApiDocumentationUnitedStates = require('index'); // See note below*.
* var xxxSvc = new ResellerApiDocumentationUnitedStates.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ResellerApiDocumentationUnitedStates.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ResellerApiDocumentationUnitedStates.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ResellerApiDocumentationUnitedStates.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
