...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser();
  });
  ...
  describe('OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser', function() {
    it('should create an instance of OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser', function() {
      ...
      //var instance = new ResellerApi.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser();
      //expect(instance).to.be.a(ResellerApi.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser);
    });
