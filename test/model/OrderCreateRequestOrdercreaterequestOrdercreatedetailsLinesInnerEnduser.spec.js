...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser();
  });
  ...
  describe('OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser', function() {
    it('should create an instance of OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser);
    });
