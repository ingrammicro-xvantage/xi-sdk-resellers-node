...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser();
  });
  ...
  describe('OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser', function() {
    it('should create an instance of OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser', function() {
      ...
      //var instance = new XiSdkResellers.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser);
    });
