...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyRequestLinesInner();
  });
  ...
  describe('OrderModifyRequestLinesInner', function() {
    it('should create an instance of OrderModifyRequestLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyRequestLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyRequestLinesInner);
    });
