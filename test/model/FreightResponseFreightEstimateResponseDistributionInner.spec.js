...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.FreightResponseFreightEstimateResponseDistributionInner();
  });
  ...
  describe('FreightResponseFreightEstimateResponseDistributionInner', function() {
    it('should create an instance of FreightResponseFreightEstimateResponseDistributionInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.FreightResponseFreightEstimateResponseDistributionInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.FreightResponseFreightEstimateResponseDistributionInner);
    });
