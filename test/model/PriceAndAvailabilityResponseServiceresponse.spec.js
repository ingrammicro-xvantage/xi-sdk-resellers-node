...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseServiceresponse();
  });
  ...
  describe('PriceAndAvailabilityResponseServiceresponse', function() {
    it('should create an instance of PriceAndAvailabilityResponseServiceresponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseServiceresponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseServiceresponse);
    });
