...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ErrorResponseErrorsInnerFieldsInner();
  });
  ...
  describe('ErrorResponseErrorsInnerFieldsInner', function() {
    it('should create an instance of ErrorResponseErrorsInnerFieldsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ErrorResponseErrorsInnerFieldsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ErrorResponseErrorsInnerFieldsInner);
    });
