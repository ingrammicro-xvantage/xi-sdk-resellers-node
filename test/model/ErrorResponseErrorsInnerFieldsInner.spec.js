...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.ErrorResponseErrorsInnerFieldsInner();
  });
  ...
  describe('ErrorResponseErrorsInnerFieldsInner', function() {
    it('should create an instance of ErrorResponseErrorsInnerFieldsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.ErrorResponseErrorsInnerFieldsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.ErrorResponseErrorsInnerFieldsInner);
    });
