...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderCreateRequestLinesInnerEndUserInfoInner();
  });
  ...
  describe('OrderCreateRequestLinesInnerEndUserInfoInner', function() {
    it('should create an instance of OrderCreateRequestLinesInnerEndUserInfoInner', function() {
      // uncomment below and update the code to test OrderCreateRequestLinesInnerEndUserInfoInner
      //var instance = new ResellerApiDocumentationUnitedStates.OrderCreateRequestLinesInnerEndUserInfoInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderCreateRequestLinesInnerEndUserInfoInner);
    });

    it('should have the property endUserType (base name: "endUserType")', function() {
