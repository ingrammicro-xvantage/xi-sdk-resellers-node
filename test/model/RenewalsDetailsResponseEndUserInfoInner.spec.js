...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsDetailsResponseEndUserInfoInner();
  });
  ...
  describe('RenewalsDetailsResponseEndUserInfoInner', function() {
    it('should create an instance of RenewalsDetailsResponseEndUserInfoInner', function() {
      ...
      //var instance = new ResellerApi.RenewalsDetailsResponseEndUserInfoInner();
      //expect(instance).to.be.a(ResellerApi.RenewalsDetailsResponseEndUserInfoInner);
    });
