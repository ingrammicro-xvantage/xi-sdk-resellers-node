...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo();
  });
  ...
  describe('OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo', function() {
    it('should create an instance of OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo', function() {
      ...
      //var instance = new ResellerApi.OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo();
      //expect(instance).to.be.a(ResellerApi.OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo);
    });
