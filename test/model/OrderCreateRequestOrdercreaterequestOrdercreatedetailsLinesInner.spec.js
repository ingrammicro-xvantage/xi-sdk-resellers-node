...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInner();
  });
  ...
  describe('OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInner', function() {
    it('should create an instance of OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInner);
    });
