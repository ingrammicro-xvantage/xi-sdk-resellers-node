...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseRejectedLineItemsInner();
  });
  ...
  describe('OrderModifyResponseRejectedLineItemsInner', function() {
    it('should create an instance of OrderModifyResponseRejectedLineItemsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseRejectedLineItemsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyResponseRejectedLineItemsInner);
    });
