...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.QuoteCreateWebhookResponse();
  });
  ...
  describe('QuoteCreateWebhookResponse', function() {
    it('should create an instance of QuoteCreateWebhookResponse', function() {
      // uncomment below and update the code to test QuoteCreateWebhookResponse
      //var instance = new XiSdkResellers.QuoteCreateWebhookResponse();
      //expect(instance).to.be.a(XiSdkResellers.QuoteCreateWebhookResponse);
    });
