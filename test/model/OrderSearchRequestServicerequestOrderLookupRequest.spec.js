...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderSearchRequestServicerequestOrderLookupRequest();
  });
  ...
  describe('OrderSearchRequestServicerequestOrderLookupRequest', function() {
    it('should create an instance of OrderSearchRequestServicerequestOrderLookupRequest', function() {
      ...
      //var instance = new ResellerApi.OrderSearchRequestServicerequestOrderLookupRequest();
      //expect(instance).to.be.a(ResellerApi.OrderSearchRequestServicerequestOrderLookupRequest);
    });
