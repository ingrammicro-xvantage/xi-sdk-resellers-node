...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7Request();
  });
  ...
  describe('OrderCreateV7Request', function() {
    it('should create an instance of OrderCreateV7Request', function() {
      // uncomment below and update the code to test OrderCreateV7Request
      //var instance = new XiSdkResellers.OrderCreateV7Request();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7Request);
    });
