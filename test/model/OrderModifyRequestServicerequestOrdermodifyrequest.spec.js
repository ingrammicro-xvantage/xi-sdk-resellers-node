...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderModifyRequestServicerequestOrdermodifyrequest();
  });
  ...
  describe('OrderModifyRequestServicerequestOrdermodifyrequest', function() {
    it('should create an instance of OrderModifyRequestServicerequestOrdermodifyrequest', function() {
      ...
      //var instance = new ResellerApi.OrderModifyRequestServicerequestOrdermodifyrequest();
      //expect(instance).to.be.a(ResellerApi.OrderModifyRequestServicerequestOrdermodifyrequest);
    });
