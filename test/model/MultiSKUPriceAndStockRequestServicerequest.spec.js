...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.MultiSKUPriceAndStockRequestServicerequest();
  });
  ...
  describe('MultiSKUPriceAndStockRequestServicerequest', function() {
    it('should create an instance of MultiSKUPriceAndStockRequestServicerequest', function() {
      ...
      //var instance = new ResellerApi.MultiSKUPriceAndStockRequestServicerequest();
      //expect(instance).to.be.a(ResellerApi.MultiSKUPriceAndStockRequestServicerequest);
    });
