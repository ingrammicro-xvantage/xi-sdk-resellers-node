...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.MultiSKUPriceAndStockRequestServicerequest();
  });
  ...
  describe('MultiSKUPriceAndStockRequestServicerequest', function() {
    it('should create an instance of MultiSKUPriceAndStockRequestServicerequest', function() {
      ...
      //var instance = new XiSdkResellers.MultiSKUPriceAndStockRequestServicerequest();
      //expect(instance).to.be.a(XiSdkResellers.MultiSKUPriceAndStockRequestServicerequest);
    });
