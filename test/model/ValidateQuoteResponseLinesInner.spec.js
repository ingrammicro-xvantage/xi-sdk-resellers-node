...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ValidateQuoteResponseLinesInner();
  });
  ...
  describe('ValidateQuoteResponseLinesInner', function() {
    it('should create an instance of ValidateQuoteResponseLinesInner', function() {
      ...
      //var instance = new ResellerApi.ValidateQuoteResponseLinesInner();
      //expect(instance).to.be.a(ResellerApi.ValidateQuoteResponseLinesInner);
    });
