...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ValidateQuoteResponseLinesInner();
  });
  ...
  describe('ValidateQuoteResponseLinesInner', function() {
    it('should create an instance of ValidateQuoteResponseLinesInner', function() {
      // uncomment below and update the code to test ValidateQuoteResponseLinesInner
      //var instance = new ResellerApiDocumentationUnitedStates.ValidateQuoteResponseLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ValidateQuoteResponseLinesInner);
    });
