...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.RenewalsSearchRequestDataTypeInvoiceDate();
  });
  ...
  describe('RenewalsSearchRequestDataTypeInvoiceDate', function() {
    it('should create an instance of RenewalsSearchRequestDataTypeInvoiceDate', function() {
      ...
      //var instance = new ResellerApiDocumentation.RenewalsSearchRequestDataTypeInvoiceDate();
      //expect(instance).to.be.a(ResellerApiDocumentation.RenewalsSearchRequestDataTypeInvoiceDate);
    });
