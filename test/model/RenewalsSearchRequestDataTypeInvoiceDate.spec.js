...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.RenewalsSearchRequestDataTypeInvoiceDate();
  });
  ...
  describe('RenewalsSearchRequestDataTypeInvoiceDate', function() {
    it('should create an instance of RenewalsSearchRequestDataTypeInvoiceDate', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.RenewalsSearchRequestDataTypeInvoiceDate();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.RenewalsSearchRequestDataTypeInvoiceDate);
    });
