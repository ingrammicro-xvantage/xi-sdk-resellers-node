...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsSearchRequestDataTypeInvoiceDate();
  });
  ...
  describe('RenewalsSearchRequestDataTypeInvoiceDate', function() {
    it('should create an instance of RenewalsSearchRequestDataTypeInvoiceDate', function() {
      ...
      //var instance = new ResellerApi.RenewalsSearchRequestDataTypeInvoiceDate();
      //expect(instance).to.be.a(ResellerApi.RenewalsSearchRequestDataTypeInvoiceDate);
    });
