...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateResponseServiceresponseOrdercreateresponseInnerLinesInner();
  });
  ...
  describe('OrderCreateResponseServiceresponseOrdercreateresponseInnerLinesInner', function() {
    it('should create an instance of OrderCreateResponseServiceresponseOrdercreateresponseInnerLinesInner', function() {
      ...
      //var instance = new ResellerApi.OrderCreateResponseServiceresponseOrdercreateresponseInnerLinesInner();
      //expect(instance).to.be.a(ResellerApi.OrderCreateResponseServiceresponseOrdercreateresponseInnerLinesInner);
    });
