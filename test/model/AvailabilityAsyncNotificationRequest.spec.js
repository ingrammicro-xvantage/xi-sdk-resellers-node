...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.AvailabilityAsyncNotificationRequest();
  });
  ...
  describe('AvailabilityAsyncNotificationRequest', function() {
    it('should create an instance of AvailabilityAsyncNotificationRequest', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.AvailabilityAsyncNotificationRequest();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.AvailabilityAsyncNotificationRequest);
    });
