...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDeleteRequestServicerequestOrderDeleteRequestDetails();
  });
  ...
  describe('OrderDeleteRequestServicerequestOrderDeleteRequestDetails', function() {
    it('should create an instance of OrderDeleteRequestServicerequestOrderDeleteRequestDetails', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDeleteRequestServicerequestOrderDeleteRequestDetails();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDeleteRequestServicerequestOrderDeleteRequestDetails);
    });
