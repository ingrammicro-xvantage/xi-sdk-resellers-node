...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDeleteRequestServicerequestOrderDeleteRequestDetails();
  });
  ...
  describe('OrderDeleteRequestServicerequestOrderDeleteRequestDetails', function() {
    it('should create an instance of OrderDeleteRequestServicerequestOrderDeleteRequestDetails', function() {
      ...
      //var instance = new ResellerApi.OrderDeleteRequestServicerequestOrderDeleteRequestDetails();
      //expect(instance).to.be.a(ResellerApi.OrderDeleteRequestServicerequestOrderDeleteRequestDetails);
    });
