...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BEndUserInfo();
  });
  ...
  describe('OrderDetailB2BEndUserInfo', function() {
    it('should create an instance of OrderDetailB2BEndUserInfo', function() {
      // uncomment below and update the code to test OrderDetailB2BEndUserInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BEndUserInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BEndUserInfo);
    });
