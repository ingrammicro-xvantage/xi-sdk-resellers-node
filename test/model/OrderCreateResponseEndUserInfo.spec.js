...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderCreateResponseEndUserInfo();
  });
  ...
  describe('OrderCreateResponseEndUserInfo', function() {
    it('should create an instance of OrderCreateResponseEndUserInfo', function() {
      // uncomment below and update the code to test OrderCreateResponseEndUserInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderCreateResponseEndUserInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderCreateResponseEndUserInfo);
    });
