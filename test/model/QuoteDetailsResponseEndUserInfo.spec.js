...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsResponseEndUserInfo();
  });
  ...
  describe('QuoteDetailsResponseEndUserInfo', function() {
    it('should create an instance of QuoteDetailsResponseEndUserInfo', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsResponseEndUserInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteDetailsResponseEndUserInfo);
    });
