...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteDetailsResponseEndUserInfo();
  });
  ...
  describe('QuoteDetailsResponseEndUserInfo', function() {
    it('should create an instance of QuoteDetailsResponseEndUserInfo', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteDetailsResponseEndUserInfo();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteDetailsResponseEndUserInfo);
    });
