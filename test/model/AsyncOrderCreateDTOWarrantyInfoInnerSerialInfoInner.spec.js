...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOWarrantyInfoInnerSerialInfoInner();
  });
  ...
  describe('AsyncOrderCreateDTOWarrantyInfoInnerSerialInfoInner', function() {
    it('should create an instance of AsyncOrderCreateDTOWarrantyInfoInnerSerialInfoInner', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOWarrantyInfoInnerSerialInfoInner
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOWarrantyInfoInnerSerialInfoInner();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOWarrantyInfoInnerSerialInfoInner);
    });
