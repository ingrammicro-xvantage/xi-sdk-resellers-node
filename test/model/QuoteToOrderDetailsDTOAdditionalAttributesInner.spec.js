...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteToOrderDetailsDTOAdditionalAttributesInner();
  });
  ...
  describe('QuoteToOrderDetailsDTOAdditionalAttributesInner', function() {
    it('should create an instance of QuoteToOrderDetailsDTOAdditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteToOrderDetailsDTOAdditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteToOrderDetailsDTOAdditionalAttributesInner);
    });
