...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteToOrderDetailsDTOAdditionalAttributesInner();
  });
  ...
  describe('QuoteToOrderDetailsDTOAdditionalAttributesInner', function() {
    it('should create an instance of QuoteToOrderDetailsDTOAdditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteToOrderDetailsDTOAdditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteToOrderDetailsDTOAdditionalAttributesInner);
    });
