...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.QuoteCreateWebhookResponseResourceProductsInner();
  });
  ...
  describe('QuoteCreateWebhookResponseResourceProductsInner', function() {
    it('should create an instance of QuoteCreateWebhookResponseResourceProductsInner', function() {
      // uncomment below and update the code to test QuoteCreateWebhookResponseResourceProductsInner
      //var instance = new XiSdkResellers.QuoteCreateWebhookResponseResourceProductsInner();
      //expect(instance).to.be.a(XiSdkResellers.QuoteCreateWebhookResponseResourceProductsInner);
    });
