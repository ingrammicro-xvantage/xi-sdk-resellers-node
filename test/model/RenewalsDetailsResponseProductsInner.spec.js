...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.RenewalsDetailsResponseProductsInner();
  });
  ...
  describe('RenewalsDetailsResponseProductsInner', function() {
    it('should create an instance of RenewalsDetailsResponseProductsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.RenewalsDetailsResponseProductsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.RenewalsDetailsResponseProductsInner);
    });
