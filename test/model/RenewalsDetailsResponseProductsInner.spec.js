...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.RenewalsDetailsResponseProductsInner();
  });
  ...
  describe('RenewalsDetailsResponseProductsInner', function() {
    it('should create an instance of RenewalsDetailsResponseProductsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.RenewalsDetailsResponseProductsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.RenewalsDetailsResponseProductsInner);
    });
