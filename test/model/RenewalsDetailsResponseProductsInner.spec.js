...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsDetailsResponseProductsInner();
  });
  ...
  describe('RenewalsDetailsResponseProductsInner', function() {
    it('should create an instance of RenewalsDetailsResponseProductsInner', function() {
      ...
      //var instance = new ResellerApi.RenewalsDetailsResponseProductsInner();
      //expect(instance).to.be.a(ResellerApi.RenewalsDetailsResponseProductsInner);
    });
