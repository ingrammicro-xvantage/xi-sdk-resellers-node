...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteDetailsQuoteDetailResponse();
  });
  ...
  describe('QuoteDetailsQuoteDetailResponse', function() {
    it('should create an instance of QuoteDetailsQuoteDetailResponse', function() {
      ...
      //var instance = new ResellerApi.QuoteDetailsQuoteDetailResponse();
      //expect(instance).to.be.a(ResellerApi.QuoteDetailsQuoteDetailResponse);
    });
