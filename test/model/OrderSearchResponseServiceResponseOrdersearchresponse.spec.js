...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseOrdersearchresponse();
  });
  ...
  describe('OrderSearchResponseServiceResponseOrdersearchresponse', function() {
    it('should create an instance of OrderSearchResponseServiceResponseOrdersearchresponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseOrdersearchresponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseOrdersearchresponse);
    });
