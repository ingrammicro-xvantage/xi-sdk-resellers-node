...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderSearchResponseServiceResponseOrdersearchresponse();
  });
  ...
  describe('OrderSearchResponseServiceResponseOrdersearchresponse', function() {
    it('should create an instance of OrderSearchResponseServiceResponseOrdersearchresponse', function() {
      ...
      //var instance = new ResellerApi.OrderSearchResponseServiceResponseOrdersearchresponse();
      //expect(instance).to.be.a(ResellerApi.OrderSearchResponseServiceResponseOrdersearchresponse);
    });
