...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateRequestLinesInnerWarrantyInfoInnerSerialInfoInner();
  });
  ...
  describe('OrderCreateRequestLinesInnerWarrantyInfoInnerSerialInfoInner', function() {
    it('should create an instance of OrderCreateRequestLinesInnerWarrantyInfoInnerSerialInfoInner', function() {
      ...
      //var instance = new ResellerApi.OrderCreateRequestLinesInnerWarrantyInfoInnerSerialInfoInner();
      //expect(instance).to.be.a(ResellerApi.OrderCreateRequestLinesInnerWarrantyInfoInnerSerialInfoInner);
    });
