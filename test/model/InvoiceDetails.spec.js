...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.InvoiceDetails();
  });
  ...
  describe('InvoiceDetails', function() {
    it('should create an instance of InvoiceDetails', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.InvoiceDetails();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.InvoiceDetails);
    });
