...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.InvoiceDetails();
  });
  ...
  describe('InvoiceDetails', function() {
    it('should create an instance of InvoiceDetails', function() {
      ...
      //var instance = new ResellerApiDocumentation.InvoiceDetails();
      //expect(instance).to.be.a(ResellerApiDocumentation.InvoiceDetails);
    });
