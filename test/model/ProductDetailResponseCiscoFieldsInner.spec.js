...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductDetailResponseCiscoFieldsInner();
  });
  ...
  describe('ProductDetailResponseCiscoFieldsInner', function() {
    it('should create an instance of ProductDetailResponseCiscoFieldsInner', function() {
      ...
      //var instance = new ResellerApi.ProductDetailResponseCiscoFieldsInner();
      //expect(instance).to.be.a(ResellerApi.ProductDetailResponseCiscoFieldsInner);
    });
