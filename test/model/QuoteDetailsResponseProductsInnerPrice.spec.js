...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsResponseProductsInnerPrice();
  });
  ...
  describe('QuoteDetailsResponseProductsInnerPrice', function() {
    it('should create an instance of QuoteDetailsResponseProductsInnerPrice', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsResponseProductsInnerPrice();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteDetailsResponseProductsInnerPrice);
    });
