...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner();
  });
  ...
  describe('OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner', function() {
    it('should create an instance of OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner', function() {
      // uncomment below and update the code to test OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner
      //var instance = new XiSdkResellers.OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner);
    });
