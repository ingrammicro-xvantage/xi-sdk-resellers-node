...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteToOrderDetailsDTOVmfadditionalAttributesInner();
  });
  ...
  describe('QuoteToOrderDetailsDTOVmfadditionalAttributesInner', function() {
    it('should create an instance of QuoteToOrderDetailsDTOVmfadditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApi.QuoteToOrderDetailsDTOVmfadditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApi.QuoteToOrderDetailsDTOVmfadditionalAttributesInner);
    });
