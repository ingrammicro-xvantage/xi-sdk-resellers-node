...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.FreightRequestShipToAddressInner();
  });
  ...
  describe('FreightRequestShipToAddressInner', function() {
    it('should create an instance of FreightRequestShipToAddressInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.FreightRequestShipToAddressInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.FreightRequestShipToAddressInner);
    });
