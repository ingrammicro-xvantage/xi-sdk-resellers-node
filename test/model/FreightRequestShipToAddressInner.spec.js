...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.FreightRequestShipToAddressInner();
  });
  ...
  describe('FreightRequestShipToAddressInner', function() {
    it('should create an instance of FreightRequestShipToAddressInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.FreightRequestShipToAddressInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.FreightRequestShipToAddressInner);
    });
