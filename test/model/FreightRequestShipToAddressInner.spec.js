...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.FreightRequestShipToAddressInner();
  });
  ...
  describe('FreightRequestShipToAddressInner', function() {
    it('should create an instance of FreightRequestShipToAddressInner', function() {
      ...
      //var instance = new ResellerApi.FreightRequestShipToAddressInner();
      //expect(instance).to.be.a(ResellerApi.FreightRequestShipToAddressInner);
    });
