...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateResponseOrdersInnerLinksInner();
  });
  ...
  describe('OrderCreateResponseOrdersInnerLinksInner', function() {
    it('should create an instance of OrderCreateResponseOrdersInnerLinksInner', function() {
      ...
      //var instance = new ResellerApi.OrderCreateResponseOrdersInnerLinksInner();
      //expect(instance).to.be.a(ResellerApi.OrderCreateResponseOrdersInnerLinksInner);
    });
