...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateResponseOrdersInnerLinksInner();
  });
  ...
  describe('OrderCreateResponseOrdersInnerLinksInner', function() {
    it('should create an instance of OrderCreateResponseOrdersInnerLinksInner', function() {
      ...
      //var instance = new XiSdkResellers.OrderCreateResponseOrdersInnerLinksInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateResponseOrdersInnerLinksInner);
    });
