...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderCreateResponseOrdersInnerRejectedLineItemsInner();
  });
  ...
  describe('OrderCreateResponseOrdersInnerRejectedLineItemsInner', function() {
    it('should create an instance of OrderCreateResponseOrdersInnerRejectedLineItemsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderCreateResponseOrdersInnerRejectedLineItemsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderCreateResponseOrdersInnerRejectedLineItemsInner);
    });
