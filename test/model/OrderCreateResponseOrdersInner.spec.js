...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateResponseOrdersInner();
  });
  ...
  describe('OrderCreateResponseOrdersInner', function() {
    it('should create an instance of OrderCreateResponseOrdersInner', function() {
      ...
      //var instance = new ResellerApi.OrderCreateResponseOrdersInner();
      //expect(instance).to.be.a(ResellerApi.OrderCreateResponseOrdersInner);
    });
