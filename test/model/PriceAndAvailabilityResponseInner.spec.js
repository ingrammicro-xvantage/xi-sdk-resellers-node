...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityResponseInner();
  });
  ...
  describe('PriceAndAvailabilityResponseInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseInner', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityResponseInner();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityResponseInner);
    });
