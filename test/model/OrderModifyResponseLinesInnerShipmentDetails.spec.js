...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseLinesInnerShipmentDetails();
  });
  ...
  describe('OrderModifyResponseLinesInnerShipmentDetails', function() {
    it('should create an instance of OrderModifyResponseLinesInnerShipmentDetails', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseLinesInnerShipmentDetails();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyResponseLinesInnerShipmentDetails);
    });
