...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderModifyResponseLinesInnerShipmentDetails();
  });
  ...
  describe('OrderModifyResponseLinesInnerShipmentDetails', function() {
    it('should create an instance of OrderModifyResponseLinesInnerShipmentDetails', function() {
      ...
      //var instance = new ResellerApi.OrderModifyResponseLinesInnerShipmentDetails();
      //expect(instance).to.be.a(ResellerApi.OrderModifyResponseLinesInnerShipmentDetails);
    });
