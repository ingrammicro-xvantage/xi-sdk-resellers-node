...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderModifyResponseLinesInnerShipmentDetails();
  });
  ...
  describe('OrderModifyResponseLinesInnerShipmentDetails', function() {
    it('should create an instance of OrderModifyResponseLinesInnerShipmentDetails', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderModifyResponseLinesInnerShipmentDetails();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderModifyResponseLinesInnerShipmentDetails);
    });
