...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.AddressType();
  });
  ...
  describe('AddressType', function() {
    it('should create an instance of AddressType', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.AddressType();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.AddressType);
    });
