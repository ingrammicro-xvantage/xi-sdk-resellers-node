...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.InvoiceDetailsv61ResponseSummary();
  });
  ...
  describe('InvoiceDetailsv61ResponseSummary', function() {
    it('should create an instance of InvoiceDetailsv61ResponseSummary', function() {
      ...
      //var instance = new ResellerApi.InvoiceDetailsv61ResponseSummary();
      //expect(instance).to.be.a(ResellerApi.InvoiceDetailsv61ResponseSummary);
    });
