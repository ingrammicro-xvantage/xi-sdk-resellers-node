...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderModifyResponseLinesInnerAdditionalAttributesInner();
  });
  ...
  describe('OrderModifyResponseLinesInnerAdditionalAttributesInner', function() {
    it('should create an instance of OrderModifyResponseLinesInnerAdditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApi.OrderModifyResponseLinesInnerAdditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApi.OrderModifyResponseLinesInnerAdditionalAttributesInner);
    });
