...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseLinesInnerAdditionalAttributesInner();
  });
  ...
  describe('OrderModifyResponseLinesInnerAdditionalAttributesInner', function() {
    it('should create an instance of OrderModifyResponseLinesInnerAdditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseLinesInnerAdditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyResponseLinesInnerAdditionalAttributesInner);
    });
