...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderSearchRequestServicerequestOrderLookupRequestOrderNumber();
  });
  ...
  describe('OrderSearchRequestServicerequestOrderLookupRequestOrderNumber', function() {
    it('should create an instance of OrderSearchRequestServicerequestOrderLookupRequestOrderNumber', function() {
      ...
      //var instance = new XiSdkResellers.OrderSearchRequestServicerequestOrderLookupRequestOrderNumber();
      //expect(instance).to.be.a(XiSdkResellers.OrderSearchRequestServicerequestOrderLookupRequestOrderNumber);
    });
