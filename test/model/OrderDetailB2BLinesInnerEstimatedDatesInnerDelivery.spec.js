...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery();
  });
  ...
  describe('OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery', function() {
    it('should create an instance of OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery);
    });
