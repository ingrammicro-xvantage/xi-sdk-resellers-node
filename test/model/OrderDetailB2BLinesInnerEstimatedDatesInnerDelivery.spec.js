...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery();
  });
  ...
  describe('OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery', function() {
    it('should create an instance of OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery);
    });
