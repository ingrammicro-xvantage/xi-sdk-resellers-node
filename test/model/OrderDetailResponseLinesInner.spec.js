...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderDetailResponseLinesInner();
  });
  ...
  describe('OrderDetailResponseLinesInner', function() {
    it('should create an instance of OrderDetailResponseLinesInner', function() {
      ...
      //var instance = new XiSdkResellers.OrderDetailResponseLinesInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderDetailResponseLinesInner);
    });
