...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.PriceAndAvailabilityResponseInnerSubscriptionPriceInner();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerSubscriptionPriceInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerSubscriptionPriceInner', function() {
      // uncomment below and update the code to test PriceAndAvailabilityResponseInnerSubscriptionPriceInner
      //var instance = new XiSdkResellers.PriceAndAvailabilityResponseInnerSubscriptionPriceInner();
      //expect(instance).to.be.a(XiSdkResellers.PriceAndAvailabilityResponseInnerSubscriptionPriceInner);
    });
    ...
    it('should have the property planUId (base name: "planUId")', function() {
      // uncomment below and update the code to test the property planUId
      //var instance = new XiSdkResellers.PriceAndAvailabilityResponseInnerSubscriptionPriceInner();
      //expect(instance).to.be();
    });
