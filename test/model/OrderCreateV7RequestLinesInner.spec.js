...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestLinesInner();
  });
  ...
  describe('OrderCreateV7RequestLinesInner', function() {
    it('should create an instance of OrderCreateV7RequestLinesInner', function() {
      // uncomment below and update the code to test OrderCreateV7RequestLinesInner
      //var instance = new XiSdkResellers.OrderCreateV7RequestLinesInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestLinesInner);
    });
