...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerReserveInventoryDetailsInner();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerReserveInventoryDetailsInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerReserveInventoryDetailsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerReserveInventoryDetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerReserveInventoryDetailsInner);
    });
