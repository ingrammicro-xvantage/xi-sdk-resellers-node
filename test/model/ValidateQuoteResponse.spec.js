...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ValidateQuoteResponse();
  });
  ...
  describe('ValidateQuoteResponse', function() {
    it('should create an instance of ValidateQuoteResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ValidateQuoteResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ValidateQuoteResponse);
    });
