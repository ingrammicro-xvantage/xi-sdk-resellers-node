...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOResellerInfo();
  });
  ...
  describe('AsyncOrderCreateDTOResellerInfo', function() {
    it('should create an instance of AsyncOrderCreateDTOResellerInfo', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOResellerInfo
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOResellerInfo();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOResellerInfo);
    });
