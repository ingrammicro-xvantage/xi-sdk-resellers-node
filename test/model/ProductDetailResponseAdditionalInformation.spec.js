...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductDetailResponseAdditionalInformation();
  });
  ...
  describe('ProductDetailResponseAdditionalInformation', function() {
    it('should create an instance of ProductDetailResponseAdditionalInformation', function() {
      ...
      //var instance = new ResellerApi.ProductDetailResponseAdditionalInformation();
      //expect(instance).to.be.a(ResellerApi.ProductDetailResponseAdditionalInformation);
    });
