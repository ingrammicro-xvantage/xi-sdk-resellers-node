...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOLinesInner();
  });
  ...
  describe('AsyncOrderCreateDTOLinesInner', function() {
    it('should create an instance of AsyncOrderCreateDTOLinesInner', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOLinesInner
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOLinesInner();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOLinesInner);
    });
