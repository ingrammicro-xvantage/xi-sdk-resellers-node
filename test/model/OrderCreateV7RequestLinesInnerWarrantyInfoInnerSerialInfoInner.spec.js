...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoInnerSerialInfoInner();
  });
  ...
  describe('OrderCreateV7RequestLinesInnerWarrantyInfoInnerSerialInfoInner', function() {
    it('should create an instance of OrderCreateV7RequestLinesInnerWarrantyInfoInnerSerialInfoInner', function() {
      // uncomment below and update the code to test OrderCreateV7RequestLinesInnerWarrantyInfoInnerSerialInfoInner
      //var instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoInnerSerialInfoInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoInnerSerialInfoInner);
    });
