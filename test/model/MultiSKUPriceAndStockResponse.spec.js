...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.MultiSKUPriceAndStockResponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponse', function() {
      ...
      //var instance = new ResellerApi.MultiSKUPriceAndStockResponse();
      //expect(instance).to.be.a(ResellerApi.MultiSKUPriceAndStockResponse);
    });
