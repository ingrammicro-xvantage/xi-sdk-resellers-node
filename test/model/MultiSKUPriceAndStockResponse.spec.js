...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.MultiSKUPriceAndStockResponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponse', function() {
      ...
      //var instance = new ResellerApiDocumentation.MultiSKUPriceAndStockResponse();
      //expect(instance).to.be.a(ResellerApiDocumentation.MultiSKUPriceAndStockResponse);
    });
