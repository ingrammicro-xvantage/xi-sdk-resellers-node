...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.MultiSKUPriceAndStockResponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.MultiSKUPriceAndStockResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.MultiSKUPriceAndStockResponse);
    });
