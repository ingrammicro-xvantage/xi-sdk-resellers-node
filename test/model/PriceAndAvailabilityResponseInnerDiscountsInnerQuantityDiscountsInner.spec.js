...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner);
    });
