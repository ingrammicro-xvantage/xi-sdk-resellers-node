...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner);
    });
