...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7ResponseResourceOrdersInnerLinesInner();
  });
  ...
  describe('OrderCreateV7ResponseResourceOrdersInnerLinesInner', function() {
    it('should create an instance of OrderCreateV7ResponseResourceOrdersInnerLinesInner', function() {
      // uncomment below and update the code to test OrderCreateV7ResponseResourceOrdersInnerLinesInner
      //var instance = new XiSdkResellers.OrderCreateV7ResponseResourceOrdersInnerLinesInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7ResponseResourceOrdersInnerLinesInner);
    });
