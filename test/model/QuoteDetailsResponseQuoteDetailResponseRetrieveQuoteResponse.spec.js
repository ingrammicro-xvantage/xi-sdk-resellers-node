...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse();
  });
  ...
  describe('QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse', function() {
    it('should create an instance of QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse', function() {
      ...
      //var instance = new ResellerApi.QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse();
      //expect(instance).to.be.a(ResellerApi.QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse);
    });
