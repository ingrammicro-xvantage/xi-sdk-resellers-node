...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse();
  });
  ...
  describe('QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse', function() {
    it('should create an instance of QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse', function() {
      ...
      //var instance = new XiSdkResellers.QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse();
      //expect(instance).to.be.a(XiSdkResellers.QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse);
    });
