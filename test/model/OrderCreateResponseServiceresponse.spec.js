...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderCreateResponseServiceresponse();
  });
  ...
  describe('OrderCreateResponseServiceresponse', function() {
    it('should create an instance of OrderCreateResponseServiceresponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderCreateResponseServiceresponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderCreateResponseServiceresponse);
    });
