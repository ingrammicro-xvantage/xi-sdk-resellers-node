...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsSearchResponse();
  });
  ...
  describe('RenewalsSearchResponse', function() {
    it('should create an instance of RenewalsSearchResponse', function() {
      ...
      //var instance = new ResellerApi.RenewalsSearchResponse();
      //expect(instance).to.be.a(ResellerApi.RenewalsSearchResponse);
    });
