...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.RenewalsSearchResponse();
  });
  ...
  describe('RenewalsSearchResponse', function() {
    it('should create an instance of RenewalsSearchResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.RenewalsSearchResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.RenewalsSearchResponse);
    });
