...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner();
  });
  ...
  describe('PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner', function() {
      ...
      //var instance = new XiSdkResellers.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner();
      //expect(instance).to.be.a(XiSdkResellers.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner);
    });
