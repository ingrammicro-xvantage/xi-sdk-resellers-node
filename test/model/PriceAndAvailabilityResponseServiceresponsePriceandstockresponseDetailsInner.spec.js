...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner();
  });
  ...
  describe('PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner);
    });
