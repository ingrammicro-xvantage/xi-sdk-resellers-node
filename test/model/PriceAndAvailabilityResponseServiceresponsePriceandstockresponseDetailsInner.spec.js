...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner();
  });
  ...
  describe('PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner);
    });
