...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetailsTrackingDetailsInner();
  });
  ...
  describe('OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetailsTrackingDetailsInner', function() {
    it('should create an instance of OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetailsTrackingDetailsInner', function() {
      ...
      //var instance = new ResellerApi.OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetailsTrackingDetailsInner();
      //expect(instance).to.be.a(ResellerApi.OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetailsTrackingDetailsInner);
    });
