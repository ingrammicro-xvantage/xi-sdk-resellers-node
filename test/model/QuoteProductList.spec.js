...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteProductList();
  });
  ...
  describe('QuoteProductList', function() {
    it('should create an instance of QuoteProductList', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteProductList();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteProductList);
    });
