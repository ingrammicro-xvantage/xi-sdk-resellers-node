...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ReturnsCreateRequest();
  });
  ...
  describe('ReturnsCreateRequest', function() {
    it('should create an instance of ReturnsCreateRequest', function() {
      ...
      //var instance = new ResellerApi.ReturnsCreateRequest();
      //expect(instance).to.be.a(ResellerApi.ReturnsCreateRequest);
    });
