...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOShipmentDetails();
  });
  ...
  describe('AsyncOrderCreateDTOShipmentDetails', function() {
    it('should create an instance of AsyncOrderCreateDTOShipmentDetails', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOShipmentDetails
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOShipmentDetails();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOShipmentDetails);
    });
