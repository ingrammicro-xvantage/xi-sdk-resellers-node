...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ReturnsSearchResponse();
  });
  ...
  describe('ReturnsSearchResponse', function() {
    it('should create an instance of ReturnsSearchResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ReturnsSearchResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ReturnsSearchResponse);
    });
