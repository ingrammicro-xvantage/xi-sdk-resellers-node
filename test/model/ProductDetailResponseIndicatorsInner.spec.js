...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ProductDetailResponseIndicatorsInner();
  });
  ...
  describe('ProductDetailResponseIndicatorsInner', function() {
    it('should create an instance of ProductDetailResponseIndicatorsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ProductDetailResponseIndicatorsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ProductDetailResponseIndicatorsInner);
    });
