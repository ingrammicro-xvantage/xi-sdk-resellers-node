...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailB2BLinesInnerShipmentDetailsInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerShipmentDetailsInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerShipmentDetailsInner', function() {
      ...
      //var instance = new ResellerApi.OrderDetailB2BLinesInnerShipmentDetailsInner();
      //expect(instance).to.be.a(ResellerApi.OrderDetailB2BLinesInnerShipmentDetailsInner);
    });
