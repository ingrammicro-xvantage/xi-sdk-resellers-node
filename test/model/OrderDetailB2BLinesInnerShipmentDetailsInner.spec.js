...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerShipmentDetailsInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerShipmentDetailsInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerShipmentDetailsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerShipmentDetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerShipmentDetailsInner);
    });
