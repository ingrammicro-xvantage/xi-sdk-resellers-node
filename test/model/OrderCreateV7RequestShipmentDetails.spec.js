...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestShipmentDetails();
  });
  ...
  describe('OrderCreateV7RequestShipmentDetails', function() {
    it('should create an instance of OrderCreateV7RequestShipmentDetails', function() {
      // uncomment below and update the code to test OrderCreateV7RequestShipmentDetails
      //var instance = new XiSdkResellers.OrderCreateV7RequestShipmentDetails();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestShipmentDetails);
    });
