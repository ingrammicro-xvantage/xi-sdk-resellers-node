...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.InvoiceDetailResponseServiceresponseResponsepreamble();
  });
  ...
  describe('InvoiceDetailResponseServiceresponseResponsepreamble', function() {
    it('should create an instance of InvoiceDetailResponseServiceresponseResponsepreamble', function() {
      ...
      //var instance = new ResellerApi.InvoiceDetailResponseServiceresponseResponsepreamble();
      //expect(instance).to.be.a(ResellerApi.InvoiceDetailResponseServiceresponseResponsepreamble);
    });
