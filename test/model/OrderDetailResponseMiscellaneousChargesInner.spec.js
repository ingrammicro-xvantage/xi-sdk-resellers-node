...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseMiscellaneousChargesInner();
  });
  ...
  describe('OrderDetailResponseMiscellaneousChargesInner', function() {
    it('should create an instance of OrderDetailResponseMiscellaneousChargesInner', function() {
      // uncomment below and update the code to test OrderDetailResponseMiscellaneousChargesInner
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseMiscellaneousChargesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailResponseMiscellaneousChargesInner);
    });
