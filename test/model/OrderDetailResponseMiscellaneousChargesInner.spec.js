...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderDetailResponseMiscellaneousChargesInner();
  });
  ...
  describe('OrderDetailResponseMiscellaneousChargesInner', function() {
    it('should create an instance of OrderDetailResponseMiscellaneousChargesInner', function() {
      ...
      //var instance = new XiSdkResellers.OrderDetailResponseMiscellaneousChargesInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderDetailResponseMiscellaneousChargesInner);
    });
