...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailResponseMiscellaneousChargesInner();
  });
  ...
  describe('OrderDetailResponseMiscellaneousChargesInner', function() {
    it('should create an instance of OrderDetailResponseMiscellaneousChargesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailResponseMiscellaneousChargesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailResponseMiscellaneousChargesInner);
    });
