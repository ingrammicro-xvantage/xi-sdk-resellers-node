...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseShipToInfo();
  });
  ...
  describe('OrderDetailResponseShipToInfo', function() {
    it('should create an instance of OrderDetailResponseShipToInfo', function() {
      // uncomment below and update the code to test OrderDetailResponseShipToInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseShipToInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailResponseShipToInfo);
    });
