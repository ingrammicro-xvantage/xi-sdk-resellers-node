...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateRequestOrdercreaterequestOrdercreatedetailsShiptoaddress();
  });
  ...
  describe('OrderCreateRequestOrdercreaterequestOrdercreatedetailsShiptoaddress', function() {
    it('should create an instance of OrderCreateRequestOrdercreaterequestOrdercreatedetailsShiptoaddress', function() {
      ...
      //var instance = new ResellerApi.OrderCreateRequestOrdercreaterequestOrdercreatedetailsShiptoaddress();
      //expect(instance).to.be.a(ResellerApi.OrderCreateRequestOrdercreaterequestOrdercreatedetailsShiptoaddress);
    });
