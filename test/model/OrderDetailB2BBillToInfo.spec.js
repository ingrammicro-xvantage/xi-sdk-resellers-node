...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BBillToInfo();
  });
  ...
  describe('OrderDetailB2BBillToInfo', function() {
    it('should create an instance of OrderDetailB2BBillToInfo', function() {
      // uncomment below and update the code to test OrderDetailB2BBillToInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BBillToInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BBillToInfo);
    });
