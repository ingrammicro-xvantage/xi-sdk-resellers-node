...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseSummaryTotals();
  });
  ...
  describe('InvoiceDetailsv61ResponseSummaryTotals', function() {
    it('should create an instance of InvoiceDetailsv61ResponseSummaryTotals', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseSummaryTotals();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseSummaryTotals);
    });
