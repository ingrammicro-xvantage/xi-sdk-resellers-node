...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteProductListPrice();
  });
  ...
  describe('QuoteProductListPrice', function() {
    it('should create an instance of QuoteProductListPrice', function() {
      ...
      //var instance = new ResellerApi.QuoteProductListPrice();
      //expect(instance).to.be.a(ResellerApi.QuoteProductListPrice);
    });
