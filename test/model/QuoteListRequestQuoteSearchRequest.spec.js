...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteListRequestQuoteSearchRequest();
  });
  ...
  describe('QuoteListRequestQuoteSearchRequest', function() {
    it('should create an instance of QuoteListRequestQuoteSearchRequest', function() {
      ...
      //var instance = new ResellerApi.QuoteListRequestQuoteSearchRequest();
      //expect(instance).to.be.a(ResellerApi.QuoteListRequestQuoteSearchRequest);
    });
