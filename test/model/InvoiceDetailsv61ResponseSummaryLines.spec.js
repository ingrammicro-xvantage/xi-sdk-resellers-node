...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.InvoiceDetailsv61ResponseSummaryLines();
  });
  ...
  describe('InvoiceDetailsv61ResponseSummaryLines', function() {
    it('should create an instance of InvoiceDetailsv61ResponseSummaryLines', function() {
      ...
      //var instance = new ResellerApi.InvoiceDetailsv61ResponseSummaryLines();
      //expect(instance).to.be.a(ResellerApi.InvoiceDetailsv61ResponseSummaryLines);
    });
