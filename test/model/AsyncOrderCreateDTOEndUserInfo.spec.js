...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOEndUserInfo();
  });
  ...
  describe('AsyncOrderCreateDTOEndUserInfo', function() {
    it('should create an instance of AsyncOrderCreateDTOEndUserInfo', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOEndUserInfo
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOEndUserInfo();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOEndUserInfo);
    });
