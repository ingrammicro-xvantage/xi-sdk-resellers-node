...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateRequestLinesInner();
  });
  ...
  describe('OrderCreateRequestLinesInner', function() {
    it('should create an instance of OrderCreateRequestLinesInner', function() {
      ...
      //var instance = new ResellerApi.OrderCreateRequestLinesInner();
      //expect(instance).to.be.a(ResellerApi.OrderCreateRequestLinesInner);
    });
