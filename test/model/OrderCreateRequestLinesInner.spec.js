...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateRequestLinesInner();
  });
  ...
  describe('OrderCreateRequestLinesInner', function() {
    it('should create an instance of OrderCreateRequestLinesInner', function() {
      ...
      //var instance = new XiSdkResellers.OrderCreateRequestLinesInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateRequestLinesInner);
    });
