...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseSummaryForeignFxTotals();
  });
  ...
  describe('InvoiceDetailsv61ResponseSummaryForeignFxTotals', function() {
    it('should create an instance of InvoiceDetailsv61ResponseSummaryForeignFxTotals', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseSummaryForeignFxTotals();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseSummaryForeignFxTotals);
    });
