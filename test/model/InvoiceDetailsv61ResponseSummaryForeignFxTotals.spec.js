...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.InvoiceDetailsv61ResponseSummaryForeignFxTotals();
  });
  ...
  describe('InvoiceDetailsv61ResponseSummaryForeignFxTotals', function() {
    it('should create an instance of InvoiceDetailsv61ResponseSummaryForeignFxTotals', function() {
      ...
      //var instance = new ResellerApiDocumentation.InvoiceDetailsv61ResponseSummaryForeignFxTotals();
      //expect(instance).to.be.a(ResellerApiDocumentation.InvoiceDetailsv61ResponseSummaryForeignFxTotals);
    });
