...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderStatusAsyncNotificationRequestResourceInnerLinksInner();
  });
  ...
  describe('OrderStatusAsyncNotificationRequestResourceInnerLinksInner', function() {
    it('should create an instance of OrderStatusAsyncNotificationRequestResourceInnerLinksInner', function() {
      ...
      //var instance = new ResellerApi.OrderStatusAsyncNotificationRequestResourceInnerLinksInner();
      //expect(instance).to.be.a(ResellerApi.OrderStatusAsyncNotificationRequestResourceInnerLinksInner);
    });
