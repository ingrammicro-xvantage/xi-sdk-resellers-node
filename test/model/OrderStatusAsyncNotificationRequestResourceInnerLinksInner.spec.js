...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderStatusAsyncNotificationRequestResourceInnerLinksInner();
  });
  ...
  describe('OrderStatusAsyncNotificationRequestResourceInnerLinksInner', function() {
    it('should create an instance of OrderStatusAsyncNotificationRequestResourceInnerLinksInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderStatusAsyncNotificationRequestResourceInnerLinksInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderStatusAsyncNotificationRequestResourceInnerLinksInner);
    });
