...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderStatusAsyncNotificationRequestResourceInnerLinksInner();
  });
  ...
  describe('OrderStatusAsyncNotificationRequestResourceInnerLinksInner', function() {
    it('should create an instance of OrderStatusAsyncNotificationRequestResourceInnerLinksInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderStatusAsyncNotificationRequestResourceInnerLinksInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderStatusAsyncNotificationRequestResourceInnerLinksInner);
    });
