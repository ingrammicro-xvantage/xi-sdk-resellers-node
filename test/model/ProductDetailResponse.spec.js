...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductDetailResponse();
  });
  ...
  describe('ProductDetailResponse', function() {
    it('should create an instance of ProductDetailResponse', function() {
      ...
      //var instance = new ResellerApi.ProductDetailResponse();
      //expect(instance).to.be.a(ResellerApi.ProductDetailResponse);
    });
