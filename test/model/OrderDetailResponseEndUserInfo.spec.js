...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailResponseEndUserInfo();
  });
  ...
  describe('OrderDetailResponseEndUserInfo', function() {
    it('should create an instance of OrderDetailResponseEndUserInfo', function() {
      ...
      //var instance = new ResellerApi.OrderDetailResponseEndUserInfo();
      //expect(instance).to.be.a(ResellerApi.OrderDetailResponseEndUserInfo);
    });
