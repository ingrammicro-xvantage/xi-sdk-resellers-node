...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailResponseEndUserInfo();
  });
  ...
  describe('OrderDetailResponseEndUserInfo', function() {
    it('should create an instance of OrderDetailResponseEndUserInfo', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailResponseEndUserInfo();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailResponseEndUserInfo);
    });
