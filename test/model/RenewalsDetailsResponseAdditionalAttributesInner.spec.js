...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsDetailsResponseAdditionalAttributesInner();
  });
  ...
  describe('RenewalsDetailsResponseAdditionalAttributesInner', function() {
    it('should create an instance of RenewalsDetailsResponseAdditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApi.RenewalsDetailsResponseAdditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApi.RenewalsDetailsResponseAdditionalAttributesInner);
    });
