...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner', function() {
      // uncomment below and update the code to test MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner
      //var instance = new ResellerApiDocumentationUnitedStates.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner);
    });
