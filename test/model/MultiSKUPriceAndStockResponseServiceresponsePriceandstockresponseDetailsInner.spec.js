...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner', function() {
      ...
      //var instance = new ResellerApi.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner();
      //expect(instance).to.be.a(ResellerApi.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner);
    });
