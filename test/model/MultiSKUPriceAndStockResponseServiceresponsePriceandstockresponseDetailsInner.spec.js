...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner', function() {
      ...
      //var instance = new XiSdkResellers.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner();
      //expect(instance).to.be.a(XiSdkResellers.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner);
    });
