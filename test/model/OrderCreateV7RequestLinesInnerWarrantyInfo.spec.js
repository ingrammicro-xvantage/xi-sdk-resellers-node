...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfo();
  });
  ...
  describe('OrderCreateV7RequestLinesInnerWarrantyInfo', function() {
    it('should create an instance of OrderCreateV7RequestLinesInnerWarrantyInfo', function() {
      // uncomment below and update the code to test OrderCreateV7RequestLinesInnerWarrantyInfo
      //var instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfo();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfo);
    });
