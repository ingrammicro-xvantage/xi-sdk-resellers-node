...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner);
    });
