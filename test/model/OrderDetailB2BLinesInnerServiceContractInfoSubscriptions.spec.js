...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailB2BLinesInnerServiceContractInfoSubscriptions();
  });
  ...
  describe('OrderDetailB2BLinesInnerServiceContractInfoSubscriptions', function() {
    it('should create an instance of OrderDetailB2BLinesInnerServiceContractInfoSubscriptions', function() {
      ...
      //var instance = new ResellerApi.OrderDetailB2BLinesInnerServiceContractInfoSubscriptions();
      //expect(instance).to.be.a(ResellerApi.OrderDetailB2BLinesInnerServiceContractInfoSubscriptions);
    });
