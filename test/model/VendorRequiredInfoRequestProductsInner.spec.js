...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.VendorRequiredInfoRequestProductsInner();
  });
  ...
  describe('VendorRequiredInfoRequestProductsInner', function() {
    it('should create an instance of VendorRequiredInfoRequestProductsInner', function() {
      // uncomment below and update the code to test VendorRequiredInfoRequestProductsInner
      //var instance = new XiSdkResellers.VendorRequiredInfoRequestProductsInner();
      //expect(instance).to.be.a(XiSdkResellers.VendorRequiredInfoRequestProductsInner);
    });
