...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerScheduleLinesInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerScheduleLinesInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerScheduleLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerScheduleLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerScheduleLinesInner);
    });
