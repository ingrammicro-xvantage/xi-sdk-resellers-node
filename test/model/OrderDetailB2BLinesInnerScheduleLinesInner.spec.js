...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerScheduleLinesInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerScheduleLinesInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerScheduleLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerScheduleLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailB2BLinesInnerScheduleLinesInner);
    });
