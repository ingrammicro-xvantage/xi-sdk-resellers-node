...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductSearchResponseCatalogInnerLinksInner();
  });
  ...
  describe('ProductSearchResponseCatalogInnerLinksInner', function() {
    it('should create an instance of ProductSearchResponseCatalogInnerLinksInner', function() {
      ...
      //var instance = new ResellerApi.ProductSearchResponseCatalogInnerLinksInner();
      //expect(instance).to.be.a(ResellerApi.ProductSearchResponseCatalogInnerLinksInner);
    });
