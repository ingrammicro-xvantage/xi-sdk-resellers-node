...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ProductSearchResponseCatalogInnerLinksInner();
  });
  ...
  describe('ProductSearchResponseCatalogInnerLinksInner', function() {
    it('should create an instance of ProductSearchResponseCatalogInnerLinksInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ProductSearchResponseCatalogInnerLinksInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ProductSearchResponseCatalogInnerLinksInner);
    });
