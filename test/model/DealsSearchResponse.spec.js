...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.DealsSearchResponse();
  });
  ...
  describe('DealsSearchResponse', function() {
    it('should create an instance of DealsSearchResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.DealsSearchResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.DealsSearchResponse);
    });
