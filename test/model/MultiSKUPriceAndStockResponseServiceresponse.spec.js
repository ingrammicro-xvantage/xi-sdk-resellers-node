...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.MultiSKUPriceAndStockResponseServiceresponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponse', function() {
      ...
      //var instance = new XiSdkResellers.MultiSKUPriceAndStockResponseServiceresponse();
      //expect(instance).to.be.a(XiSdkResellers.MultiSKUPriceAndStockResponseServiceresponse);
    });
