...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.MultiSKUPriceAndStockResponseServiceresponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponse', function() {
      ...
      //var instance = new ResellerApi.MultiSKUPriceAndStockResponseServiceresponse();
      //expect(instance).to.be.a(ResellerApi.MultiSKUPriceAndStockResponseServiceresponse);
    });
