...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.MultiSKUPriceAndStockResponseServiceresponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponse', function() {
      ...
      //var instance = new ResellerApiDocumentation.MultiSKUPriceAndStockResponseServiceresponse();
      //expect(instance).to.be.a(ResellerApiDocumentation.MultiSKUPriceAndStockResponseServiceresponse);
    });
