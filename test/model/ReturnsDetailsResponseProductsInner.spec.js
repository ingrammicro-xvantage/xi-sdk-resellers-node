...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ReturnsDetailsResponseProductsInner();
  });
  ...
  describe('ReturnsDetailsResponseProductsInner', function() {
    it('should create an instance of ReturnsDetailsResponseProductsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ReturnsDetailsResponseProductsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ReturnsDetailsResponseProductsInner);
    });
