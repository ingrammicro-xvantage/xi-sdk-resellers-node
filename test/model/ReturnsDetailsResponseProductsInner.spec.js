...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ReturnsDetailsResponseProductsInner();
  });
  ...
  describe('ReturnsDetailsResponseProductsInner', function() {
    it('should create an instance of ReturnsDetailsResponseProductsInner', function() {
      ...
      //var instance = new ResellerApi.ReturnsDetailsResponseProductsInner();
      //expect(instance).to.be.a(ResellerApi.ReturnsDetailsResponseProductsInner);
    });
