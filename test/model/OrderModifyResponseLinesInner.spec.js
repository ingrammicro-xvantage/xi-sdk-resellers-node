...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderModifyResponseLinesInner();
  });
  ...
  describe('OrderModifyResponseLinesInner', function() {
    it('should create an instance of OrderModifyResponseLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderModifyResponseLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderModifyResponseLinesInner);
    });
