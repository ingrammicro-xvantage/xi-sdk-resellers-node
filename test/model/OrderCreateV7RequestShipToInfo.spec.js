...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestShipToInfo();
  });
  ...
  describe('OrderCreateV7RequestShipToInfo', function() {
    it('should create an instance of OrderCreateV7RequestShipToInfo', function() {
      // uncomment below and update the code to test OrderCreateV7RequestShipToInfo
      //var instance = new XiSdkResellers.OrderCreateV7RequestShipToInfo();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestShipToInfo);
    });
