...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsSearchRequest();
  });
  ...
  describe('RenewalsSearchRequest', function() {
    it('should create an instance of RenewalsSearchRequest', function() {
      ...
      //var instance = new ResellerApi.RenewalsSearchRequest();
      //expect(instance).to.be.a(ResellerApi.RenewalsSearchRequest);
    });
