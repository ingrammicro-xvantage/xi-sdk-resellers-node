...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOShipToInfo();
  });
  ...
  describe('AsyncOrderCreateDTOShipToInfo', function() {
    it('should create an instance of AsyncOrderCreateDTOShipToInfo', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOShipToInfo
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOShipToInfo();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOShipToInfo);
    });
