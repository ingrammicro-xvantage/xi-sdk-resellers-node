...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOWarrantyInfoInner();
  });
  ...
  describe('AsyncOrderCreateDTOWarrantyInfoInner', function() {
    it('should create an instance of AsyncOrderCreateDTOWarrantyInfoInner', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOWarrantyInfoInner
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOWarrantyInfoInner();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOWarrantyInfoInner);
    });
