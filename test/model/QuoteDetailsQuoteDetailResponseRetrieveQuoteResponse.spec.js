...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponse();
  });
  ...
  describe('QuoteDetailsQuoteDetailResponseRetrieveQuoteResponse', function() {
    it('should create an instance of QuoteDetailsQuoteDetailResponseRetrieveQuoteResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponse);
    });
