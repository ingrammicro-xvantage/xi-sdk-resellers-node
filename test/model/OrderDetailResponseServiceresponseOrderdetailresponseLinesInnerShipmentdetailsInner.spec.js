...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInner();
  });
  ...
  describe('OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInner', function() {
    it('should create an instance of OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInner', function() {
      ...
      //var instance = new ResellerApi.OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInner();
      //expect(instance).to.be.a(ResellerApi.OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInner);
    });
