...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoInner();
  });
  ...
  describe('OrderCreateV7RequestLinesInnerWarrantyInfoInner', function() {
    it('should create an instance of OrderCreateV7RequestLinesInnerWarrantyInfoInner', function() {
      // uncomment below and update the code to test OrderCreateV7RequestLinesInnerWarrantyInfoInner
      //var instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoInner);
    });
