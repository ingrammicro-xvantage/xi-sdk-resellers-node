...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner();
  });
  ...
  describe('OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner', function() {
    it('should create an instance of OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner);
    });
