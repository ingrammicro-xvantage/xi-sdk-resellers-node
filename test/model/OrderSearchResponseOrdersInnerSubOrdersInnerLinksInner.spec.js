...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner();
  });
  ...
  describe('OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner', function() {
    it('should create an instance of OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderSearchResponseOrdersInnerSubOrdersInnerLinksInner);
    });
