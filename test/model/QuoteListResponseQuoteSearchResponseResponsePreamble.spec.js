...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteListResponseQuoteSearchResponseResponsePreamble();
  });
  ...
  describe('QuoteListResponseQuoteSearchResponseResponsePreamble', function() {
    it('should create an instance of QuoteListResponseQuoteSearchResponseResponsePreamble', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteListResponseQuoteSearchResponseResponsePreamble();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteListResponseQuoteSearchResponseResponsePreamble);
    });
