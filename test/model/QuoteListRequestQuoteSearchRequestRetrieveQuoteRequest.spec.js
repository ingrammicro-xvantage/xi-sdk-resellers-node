...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest();
  });
  ...
  describe('QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest', function() {
    it('should create an instance of QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest);
    });
