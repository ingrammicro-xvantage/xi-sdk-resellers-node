...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.FreightResponseFreightEstimateResponse();
  });
  ...
  describe('FreightResponseFreightEstimateResponse', function() {
    it('should create an instance of FreightResponseFreightEstimateResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.FreightResponseFreightEstimateResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.FreightResponseFreightEstimateResponse);
    });
