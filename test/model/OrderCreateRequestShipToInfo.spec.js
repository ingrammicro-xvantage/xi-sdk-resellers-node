...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderCreateRequestShipToInfo();
  });
  ...
  describe('OrderCreateRequestShipToInfo', function() {
    it('should create an instance of OrderCreateRequestShipToInfo', function() {
      // uncomment below and update the code to test OrderCreateRequestShipToInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderCreateRequestShipToInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderCreateRequestShipToInfo);
    });
