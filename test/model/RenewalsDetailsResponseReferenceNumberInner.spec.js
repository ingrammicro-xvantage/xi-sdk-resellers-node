...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsDetailsResponseReferenceNumberInner();
  });
  ...
  describe('RenewalsDetailsResponseReferenceNumberInner', function() {
    it('should create an instance of RenewalsDetailsResponseReferenceNumberInner', function() {
      ...
      //var instance = new ResellerApi.RenewalsDetailsResponseReferenceNumberInner();
      //expect(instance).to.be.a(ResellerApi.RenewalsDetailsResponseReferenceNumberInner);
    });
