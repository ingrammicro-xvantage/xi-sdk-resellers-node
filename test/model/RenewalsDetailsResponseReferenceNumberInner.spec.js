...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.RenewalsDetailsResponseReferenceNumberInner();
  });
  ...
  describe('RenewalsDetailsResponseReferenceNumberInner', function() {
    it('should create an instance of RenewalsDetailsResponseReferenceNumberInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.RenewalsDetailsResponseReferenceNumberInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.RenewalsDetailsResponseReferenceNumberInner);
    });
