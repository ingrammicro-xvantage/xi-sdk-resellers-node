...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderSearchResponseServiceResponseResponsepreamble();
  });
  ...
  describe('OrderSearchResponseServiceResponseResponsepreamble', function() {
    it('should create an instance of OrderSearchResponseServiceResponseResponsepreamble', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderSearchResponseServiceResponseResponsepreamble();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderSearchResponseServiceResponseResponsepreamble);
    });
