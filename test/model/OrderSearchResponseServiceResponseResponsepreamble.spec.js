...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseResponsepreamble();
  });
  ...
  describe('OrderSearchResponseServiceResponseResponsepreamble', function() {
    it('should create an instance of OrderSearchResponseServiceResponseResponsepreamble', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseResponsepreamble();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseResponsepreamble);
    });
