...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ValidateQuoteResponseLinesInnerVmfAdditionalAttributesLinesInner();
  });
  ...
  describe('ValidateQuoteResponseLinesInnerVmfAdditionalAttributesLinesInner', function() {
    it('should create an instance of ValidateQuoteResponseLinesInnerVmfAdditionalAttributesLinesInner', function() {
      ...
      //var instance = new ResellerApi.ValidateQuoteResponseLinesInnerVmfAdditionalAttributesLinesInner();
      //expect(instance).to.be.a(ResellerApi.ValidateQuoteResponseLinesInnerVmfAdditionalAttributesLinesInner);
    });
