...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.VendorRequiredInfoRequest();
  });
  ...
  describe('VendorRequiredInfoRequest', function() {
    it('should create an instance of VendorRequiredInfoRequest', function() {
      // uncomment below and update the code to test VendorRequiredInfoRequest
      //var instance = new XiSdkResellers.VendorRequiredInfoRequest();
      //expect(instance).to.be.a(XiSdkResellers.VendorRequiredInfoRequest);
    });
