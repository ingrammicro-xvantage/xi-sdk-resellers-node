...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerMultipleShipmentsInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerMultipleShipmentsInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerMultipleShipmentsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerMultipleShipmentsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailB2BLinesInnerMultipleShipmentsInner);
    });
