...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerMultipleShipmentsInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerMultipleShipmentsInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerMultipleShipmentsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerMultipleShipmentsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerMultipleShipmentsInner);
    });
