...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerPricing();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerPricing', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerPricing', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerPricing();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.PriceAndAvailabilityResponseInnerPricing);
    });
