...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityResponseInnerPricing();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerPricing', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerPricing', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityResponseInnerPricing();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityResponseInnerPricing);
    });
