...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.PriceAndAvailabilityResponseInnerPricing();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerPricing', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerPricing', function() {
      ...
      //var instance = new ResellerApiDocumentation.PriceAndAvailabilityResponseInnerPricing();
      //expect(instance).to.be.a(ResellerApiDocumentation.PriceAndAvailabilityResponseInnerPricing);
    });
