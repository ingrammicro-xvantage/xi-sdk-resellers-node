...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ReturnsCreateRequestListInnerShipFromInfoInner();
  });
  ...
  describe('ReturnsCreateRequestListInnerShipFromInfoInner', function() {
    it('should create an instance of ReturnsCreateRequestListInnerShipFromInfoInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ReturnsCreateRequestListInnerShipFromInfoInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ReturnsCreateRequestListInnerShipFromInfoInner);
    });
