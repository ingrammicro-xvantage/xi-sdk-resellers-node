...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ReturnsCreateRequestListInnerShipFromInfoInner();
  });
  ...
  describe('ReturnsCreateRequestListInnerShipFromInfoInner', function() {
    it('should create an instance of ReturnsCreateRequestListInnerShipFromInfoInner', function() {
      ...
      //var instance = new ResellerApi.ReturnsCreateRequestListInnerShipFromInfoInner();
      //expect(instance).to.be.a(ResellerApi.ReturnsCreateRequestListInnerShipFromInfoInner);
    });
