...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteToOrderDetailsDTOShipToInfoInner();
  });
  ...
  describe('QuoteToOrderDetailsDTOShipToInfoInner', function() {
    it('should create an instance of QuoteToOrderDetailsDTOShipToInfoInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteToOrderDetailsDTOShipToInfoInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteToOrderDetailsDTOShipToInfoInner);
    });
