...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteToOrderDetailsDTOShipToInfoInner();
  });
  ...
  describe('QuoteToOrderDetailsDTOShipToInfoInner', function() {
    it('should create an instance of QuoteToOrderDetailsDTOShipToInfoInner', function() {
      ...
      //var instance = new ResellerApi.QuoteToOrderDetailsDTOShipToInfoInner();
      //expect(instance).to.be.a(ResellerApi.QuoteToOrderDetailsDTOShipToInfoInner);
    });
