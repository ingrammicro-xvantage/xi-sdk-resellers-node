...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteToOrderDetailsDTOShipToInfoInner();
  });
  ...
  describe('QuoteToOrderDetailsDTOShipToInfoInner', function() {
    it('should create an instance of QuoteToOrderDetailsDTOShipToInfoInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteToOrderDetailsDTOShipToInfoInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteToOrderDetailsDTOShipToInfoInner);
    });
