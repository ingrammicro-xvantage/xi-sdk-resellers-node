...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailB2BLinesInner();
  });
  ...
  describe('OrderDetailB2BLinesInner', function() {
    it('should create an instance of OrderDetailB2BLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailB2BLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailB2BLinesInner);
    });
