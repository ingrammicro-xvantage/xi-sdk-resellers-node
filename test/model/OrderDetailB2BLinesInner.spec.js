...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInner();
  });
  ...
  describe('OrderDetailB2BLinesInner', function() {
    it('should create an instance of OrderDetailB2BLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInner);
    });
