...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner();
  });
  ...
  describe('OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner', function() {
    it('should create an instance of OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner);
    });
