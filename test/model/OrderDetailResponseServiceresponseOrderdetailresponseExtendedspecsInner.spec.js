...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner();
  });
  ...
  describe('OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner', function() {
    it('should create an instance of OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner);
    });
