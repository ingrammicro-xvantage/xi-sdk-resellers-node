...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7ResponseResourceOrdersInner();
  });
  ...
  describe('OrderCreateV7ResponseResourceOrdersInner', function() {
    it('should create an instance of OrderCreateV7ResponseResourceOrdersInner', function() {
      // uncomment below and update the code to test OrderCreateV7ResponseResourceOrdersInner
      //var instance = new XiSdkResellers.OrderCreateV7ResponseResourceOrdersInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7ResponseResourceOrdersInner);
    });
