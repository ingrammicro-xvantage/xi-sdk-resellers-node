...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailB2BLinesInnerEstimatedDatesInnerShipShipDateRange();
  });
  ...
  describe('OrderDetailB2BLinesInnerEstimatedDatesInnerShipShipDateRange', function() {
    it('should create an instance of OrderDetailB2BLinesInnerEstimatedDatesInnerShipShipDateRange', function() {
      ...
      //var instance = new ResellerApi.OrderDetailB2BLinesInnerEstimatedDatesInnerShipShipDateRange();
      //expect(instance).to.be.a(ResellerApi.OrderDetailB2BLinesInnerEstimatedDatesInnerShipShipDateRange);
    });
