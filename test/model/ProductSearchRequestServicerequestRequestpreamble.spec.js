...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductSearchRequestServicerequestRequestpreamble();
  });
  ...
  describe('ProductSearchRequestServicerequestRequestpreamble', function() {
    it('should create an instance of ProductSearchRequestServicerequestRequestpreamble', function() {
      ...
      //var instance = new ResellerApi.ProductSearchRequestServicerequestRequestpreamble();
      //expect(instance).to.be.a(ResellerApi.ProductSearchRequestServicerequestRequestpreamble);
    });
