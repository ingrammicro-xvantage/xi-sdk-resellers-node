...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ReturnsCreateRequestListInner();
  });
  ...
  describe('ReturnsCreateRequestListInner', function() {
    it('should create an instance of ReturnsCreateRequestListInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ReturnsCreateRequestListInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ReturnsCreateRequestListInner);
    });
