...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.ReturnsCreateRequestListInner();
  });
  ...
  describe('ReturnsCreateRequestListInner', function() {
    it('should create an instance of ReturnsCreateRequestListInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.ReturnsCreateRequestListInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.ReturnsCreateRequestListInner);
    });
