...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ReturnsCreateRequestListInner();
  });
  ...
  describe('ReturnsCreateRequestListInner', function() {
    it('should create an instance of ReturnsCreateRequestListInner', function() {
      ...
      //var instance = new ResellerApi.ReturnsCreateRequestListInner();
      //expect(instance).to.be.a(ResellerApi.ReturnsCreateRequestListInner);
    });
