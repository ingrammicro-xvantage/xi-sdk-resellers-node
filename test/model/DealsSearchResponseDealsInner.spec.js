...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.DealsSearchResponseDealsInner();
  });
  ...
  describe('DealsSearchResponseDealsInner', function() {
    it('should create an instance of DealsSearchResponseDealsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.DealsSearchResponseDealsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.DealsSearchResponseDealsInner);
    });
