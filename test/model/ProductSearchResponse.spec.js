...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ProductSearchResponse();
  });
  ...
  describe('ProductSearchResponse', function() {
    it('should create an instance of ProductSearchResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ProductSearchResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ProductSearchResponse);
    });
