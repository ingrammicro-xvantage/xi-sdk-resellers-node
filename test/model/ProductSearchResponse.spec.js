...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.ProductSearchResponse();
  });
  ...
  describe('ProductSearchResponse', function() {
    it('should create an instance of ProductSearchResponse', function() {
      ...
      //var instance = new ResellerApiDocumentation.ProductSearchResponse();
      //expect(instance).to.be.a(ResellerApiDocumentation.ProductSearchResponse);
    });
