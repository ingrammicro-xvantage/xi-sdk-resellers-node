...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductSearchResponse();
  });
  ...
  describe('ProductSearchResponse', function() {
    it('should create an instance of ProductSearchResponse', function() {
      ...
      //var instance = new ResellerApi.ProductSearchResponse();
      //expect(instance).to.be.a(ResellerApi.ProductSearchResponse);
    });
