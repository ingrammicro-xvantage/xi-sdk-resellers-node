...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7Response();
  });
  ...
  describe('OrderCreateV7Response', function() {
    it('should create an instance of OrderCreateV7Response', function() {
      // uncomment below and update the code to test OrderCreateV7Response
      //var instance = new XiSdkResellers.OrderCreateV7Response();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7Response);
    });
