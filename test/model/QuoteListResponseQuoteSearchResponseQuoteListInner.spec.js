...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.QuoteListResponseQuoteSearchResponseQuoteListInner();
  });
  ...
  describe('QuoteListResponseQuoteSearchResponseQuoteListInner', function() {
    it('should create an instance of QuoteListResponseQuoteSearchResponseQuoteListInner', function() {
      ...
      //var instance = new ResellerApi.QuoteListResponseQuoteSearchResponseQuoteListInner();
      //expect(instance).to.be.a(ResellerApi.QuoteListResponseQuoteSearchResponseQuoteListInner);
    });
