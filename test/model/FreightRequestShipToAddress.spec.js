...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.FreightRequestShipToAddress();
  });
  ...
  describe('FreightRequestShipToAddress', function() {
    it('should create an instance of FreightRequestShipToAddress', function() {
      // uncomment below and update the code to test FreightRequestShipToAddress
      //var instance = new XiSdkResellers.FreightRequestShipToAddress();
      //expect(instance).to.be.a(XiSdkResellers.FreightRequestShipToAddress);
    });
