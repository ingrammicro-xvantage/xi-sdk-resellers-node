...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AccesstokenResponse();
  });
  ...
  describe('AccesstokenResponse', function() {
    it('should create an instance of AccesstokenResponse', function() {
      ...
      //var instance = new XiSdkResellers.AccesstokenResponse();
      //expect(instance).to.be.a(XiSdkResellers.AccesstokenResponse);
    });
