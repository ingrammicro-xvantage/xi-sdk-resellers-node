...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailResponseBillToInfo();
  });
  ...
  describe('OrderDetailResponseBillToInfo', function() {
    it('should create an instance of OrderDetailResponseBillToInfo', function() {
      ...
      //var instance = new ResellerApi.OrderDetailResponseBillToInfo();
      //expect(instance).to.be.a(ResellerApi.OrderDetailResponseBillToInfo);
    });
