...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseServiceresponse();
  });
  ...
  describe('OrderDetailResponseServiceresponse', function() {
    it('should create an instance of OrderDetailResponseServiceresponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailResponseServiceresponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailResponseServiceresponse);
    });
