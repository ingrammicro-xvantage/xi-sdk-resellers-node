...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityRequest();
  });
  ...
  describe('PriceAndAvailabilityRequest', function() {
    it('should create an instance of PriceAndAvailabilityRequest', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityRequest();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityRequest);
    });
