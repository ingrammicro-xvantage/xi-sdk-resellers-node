...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BShipToInfo();
  });
  ...
  describe('OrderDetailB2BShipToInfo', function() {
    it('should create an instance of OrderDetailB2BShipToInfo', function() {
      // uncomment below and update the code to test OrderDetailB2BShipToInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BShipToInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BShipToInfo);
    });
