...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderSearchResponseOrdersInnerLinks();
  });
  ...
  describe('OrderSearchResponseOrdersInnerLinks', function() {
    it('should create an instance of OrderSearchResponseOrdersInnerLinks', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderSearchResponseOrdersInnerLinks();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderSearchResponseOrdersInnerLinks);
    });
