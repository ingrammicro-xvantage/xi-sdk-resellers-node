...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseOrdersInnerLinks();
  });
  ...
  describe('OrderSearchResponseOrdersInnerLinks', function() {
    it('should create an instance of OrderSearchResponseOrdersInnerLinks', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseOrdersInnerLinks();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderSearchResponseOrdersInnerLinks);
    });
