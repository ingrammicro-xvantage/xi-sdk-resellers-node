...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes();
  });
  ...
  describe('QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes', function() {
    it('should create an instance of QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes);
    });
