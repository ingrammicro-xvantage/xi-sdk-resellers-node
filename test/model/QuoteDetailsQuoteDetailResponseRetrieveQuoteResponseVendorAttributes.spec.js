...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes();
  });
  ...
  describe('QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes', function() {
    it('should create an instance of QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseVendorAttributes);
    });
