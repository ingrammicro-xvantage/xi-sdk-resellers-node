...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.InvoiceSearchResponse();
  });
  ...
  describe('InvoiceSearchResponse', function() {
    it('should create an instance of InvoiceSearchResponse', function() {
      ...
      //var instance = new ResellerApi.InvoiceSearchResponse();
      //expect(instance).to.be.a(ResellerApi.InvoiceSearchResponse);
    });
