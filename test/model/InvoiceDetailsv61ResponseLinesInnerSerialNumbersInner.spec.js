...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner();
  });
  ...
  describe('InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner', function() {
    it('should create an instance of InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner);
    });
