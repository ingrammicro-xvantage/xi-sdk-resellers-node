...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner();
  });
  ...
  describe('InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner', function() {
    it('should create an instance of InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner);
    });
