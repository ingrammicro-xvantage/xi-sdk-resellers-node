...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateRequestOrdercreaterequest();
  });
  ...
  describe('OrderCreateRequestOrdercreaterequest', function() {
    it('should create an instance of OrderCreateRequestOrdercreaterequest', function() {
      ...
      //var instance = new ResellerApi.OrderCreateRequestOrdercreaterequest();
      //expect(instance).to.be.a(ResellerApi.OrderCreateRequestOrdercreaterequest);
    });
