...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerSubordersInner();
  });
  ...
  describe('OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerSubordersInner', function() {
    it('should create an instance of OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerSubordersInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerSubordersInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerSubordersInner);
    });
