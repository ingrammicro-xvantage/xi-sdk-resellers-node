...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.InvoiceDetailsv61ResponseLinesInner();
  });
  ...
  describe('InvoiceDetailsv61ResponseLinesInner', function() {
    it('should create an instance of InvoiceDetailsv61ResponseLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.InvoiceDetailsv61ResponseLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.InvoiceDetailsv61ResponseLinesInner);
    });
