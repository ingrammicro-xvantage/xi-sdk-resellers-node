...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseLinesInner();
  });
  ...
  describe('InvoiceDetailsv61ResponseLinesInner', function() {
    it('should create an instance of InvoiceDetailsv61ResponseLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.InvoiceDetailsv61ResponseLinesInner);
    });
