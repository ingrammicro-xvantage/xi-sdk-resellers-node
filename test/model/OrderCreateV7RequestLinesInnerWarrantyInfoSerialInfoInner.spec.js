...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner();
  });
  ...
  describe('OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner', function() {
    it('should create an instance of OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner', function() {
      // uncomment below and update the code to test OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner
      //var instance = new XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner();
      //expect(instance).to.be.a(XiSdkResellers.OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner);
    });
