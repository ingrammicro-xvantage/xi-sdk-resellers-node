...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.FreightRequestLinesInner();
  });
  ...
  describe('FreightRequestLinesInner', function() {
    it('should create an instance of FreightRequestLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.FreightRequestLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.FreightRequestLinesInner);
    });
