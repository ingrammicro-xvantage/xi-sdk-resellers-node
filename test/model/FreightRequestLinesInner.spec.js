...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.FreightRequestLinesInner();
  });
  ...
  describe('FreightRequestLinesInner', function() {
    it('should create an instance of FreightRequestLinesInner', function() {
      ...
      //var instance = new ResellerApi.FreightRequestLinesInner();
      //expect(instance).to.be.a(ResellerApi.FreightRequestLinesInner);
    });
