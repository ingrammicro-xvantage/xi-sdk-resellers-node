...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.FreightRequestLinesInner();
  });
  ...
  describe('FreightRequestLinesInner', function() {
    it('should create an instance of FreightRequestLinesInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.FreightRequestLinesInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.FreightRequestLinesInner);
    });
