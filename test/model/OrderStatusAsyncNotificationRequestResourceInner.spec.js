...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderStatusAsyncNotificationRequestResourceInner();
  });
  ...
  describe('OrderStatusAsyncNotificationRequestResourceInner', function() {
    it('should create an instance of OrderStatusAsyncNotificationRequestResourceInner', function() {
      ...
      //var instance = new ResellerApi.OrderStatusAsyncNotificationRequestResourceInner();
      //expect(instance).to.be.a(ResellerApi.OrderStatusAsyncNotificationRequestResourceInner);
    });
