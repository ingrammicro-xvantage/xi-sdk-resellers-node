...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.GetResellerV6ValidateQuote400ResponseFieldsInner();
  });
  ...
  describe('GetResellerV6ValidateQuote400ResponseFieldsInner', function() {
    it('should create an instance of GetResellerV6ValidateQuote400ResponseFieldsInner', function() {
      ...
      //var instance = new ResellerApi.GetResellerV6ValidateQuote400ResponseFieldsInner();
      //expect(instance).to.be.a(ResellerApi.GetResellerV6ValidateQuote400ResponseFieldsInner);
    });
