...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.QuoteCreateWebhookResponseResourceProductsInnerPrice();
  });
  ...
  describe('QuoteCreateWebhookResponseResourceProductsInnerPrice', function() {
    it('should create an instance of QuoteCreateWebhookResponseResourceProductsInnerPrice', function() {
      // uncomment below and update the code to test QuoteCreateWebhookResponseResourceProductsInnerPrice
      //var instance = new XiSdkResellers.QuoteCreateWebhookResponseResourceProductsInnerPrice();
      //expect(instance).to.be.a(XiSdkResellers.QuoteCreateWebhookResponseResourceProductsInnerPrice);
    });
