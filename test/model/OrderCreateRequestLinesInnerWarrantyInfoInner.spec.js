...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderCreateRequestLinesInnerWarrantyInfoInner();
  });
  ...
  describe('OrderCreateRequestLinesInnerWarrantyInfoInner', function() {
    it('should create an instance of OrderCreateRequestLinesInnerWarrantyInfoInner', function() {
      ...
      //var instance = new ResellerApi.OrderCreateRequestLinesInnerWarrantyInfoInner();
      //expect(instance).to.be.a(ResellerApi.OrderCreateRequestLinesInnerWarrantyInfoInner);
    });
