...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ProductLineTypeTrackingnumberdetailsInner();
  });
  ...
  describe('ProductLineTypeTrackingnumberdetailsInner', function() {
    it('should create an instance of ProductLineTypeTrackingnumberdetailsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ProductLineTypeTrackingnumberdetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ProductLineTypeTrackingnumberdetailsInner);
    });
