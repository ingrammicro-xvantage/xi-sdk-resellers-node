...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderSearchResponseOrdersInner();
  });
  ...
  describe('OrderSearchResponseOrdersInner', function() {
    it('should create an instance of OrderSearchResponseOrdersInner', function() {
      ...
      //var instance = new ResellerApi.OrderSearchResponseOrdersInner();
      //expect(instance).to.be.a(ResellerApi.OrderSearchResponseOrdersInner);
    });
