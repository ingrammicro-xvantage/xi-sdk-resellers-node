...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ValidateQuoteResponseVmfAdditionalAttributesInner();
  });
  ...
  describe('ValidateQuoteResponseVmfAdditionalAttributesInner', function() {
    it('should create an instance of ValidateQuoteResponseVmfAdditionalAttributesInner', function() {
      ...
      //var instance = new ResellerApi.ValidateQuoteResponseVmfAdditionalAttributesInner();
      //expect(instance).to.be.a(ResellerApi.ValidateQuoteResponseVmfAdditionalAttributesInner);
    });
