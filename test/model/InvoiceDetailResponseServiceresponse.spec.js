...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.InvoiceDetailResponseServiceresponse();
  });
  ...
  describe('InvoiceDetailResponseServiceresponse', function() {
    it('should create an instance of InvoiceDetailResponseServiceresponse', function() {
      ...
      //var instance = new ResellerApi.InvoiceDetailResponseServiceresponse();
      //expect(instance).to.be.a(ResellerApi.InvoiceDetailResponseServiceresponse);
    });
