...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderModifyResponse();
  });
  ...
  describe('OrderModifyResponse', function() {
    it('should create an instance of OrderModifyResponse', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderModifyResponse();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderModifyResponse);
    });
