...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponse();
  });
  ...
  describe('OrderModifyResponse', function() {
    it('should create an instance of OrderModifyResponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyResponse);
    });
