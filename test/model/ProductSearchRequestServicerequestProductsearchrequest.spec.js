...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductSearchRequestServicerequestProductsearchrequest();
  });
  ...
  describe('ProductSearchRequestServicerequestProductsearchrequest', function() {
    it('should create an instance of ProductSearchRequestServicerequestProductsearchrequest', function() {
      ...
      //var instance = new ResellerApi.ProductSearchRequestServicerequestProductsearchrequest();
      //expect(instance).to.be.a(ResellerApi.ProductSearchRequestServicerequestProductsearchrequest);
    });
