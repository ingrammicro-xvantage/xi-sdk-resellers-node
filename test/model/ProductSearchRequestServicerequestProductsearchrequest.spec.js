...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.ProductSearchRequestServicerequestProductsearchrequest();
  });
  ...
  describe('ProductSearchRequestServicerequestProductsearchrequest', function() {
    it('should create an instance of ProductSearchRequestServicerequestProductsearchrequest', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.ProductSearchRequestServicerequestProductsearchrequest();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.ProductSearchRequestServicerequestProductsearchrequest);
    });
