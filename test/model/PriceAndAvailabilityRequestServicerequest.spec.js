...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.PriceAndAvailabilityRequestServicerequest();
  });
  ...
  describe('PriceAndAvailabilityRequestServicerequest', function() {
    it('should create an instance of PriceAndAvailabilityRequestServicerequest', function() {
      ...
      //var instance = new XiSdkResellers.PriceAndAvailabilityRequestServicerequest();
      //expect(instance).to.be.a(XiSdkResellers.PriceAndAvailabilityRequestServicerequest);
    });
