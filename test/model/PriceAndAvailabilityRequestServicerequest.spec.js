...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityRequestServicerequest();
  });
  ...
  describe('PriceAndAvailabilityRequestServicerequest', function() {
    it('should create an instance of PriceAndAvailabilityRequestServicerequest', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityRequestServicerequest();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityRequestServicerequest);
    });
