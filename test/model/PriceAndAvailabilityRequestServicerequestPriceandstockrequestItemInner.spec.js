...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner();
  });
  ...
  describe('PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner', function() {
    it('should create an instance of PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner);
    });
