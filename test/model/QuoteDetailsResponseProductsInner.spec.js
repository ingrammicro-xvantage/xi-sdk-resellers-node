...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsResponseProductsInner();
  });
  ...
  describe('QuoteDetailsResponseProductsInner', function() {
    it('should create an instance of QuoteDetailsResponseProductsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.QuoteDetailsResponseProductsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.QuoteDetailsResponseProductsInner);
    });
