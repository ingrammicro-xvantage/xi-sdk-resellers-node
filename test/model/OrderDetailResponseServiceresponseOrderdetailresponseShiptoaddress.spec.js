...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.OrderDetailResponseServiceresponseOrderdetailresponseShiptoaddress();
  });
  ...
  describe('OrderDetailResponseServiceresponseOrderdetailresponseShiptoaddress', function() {
    it('should create an instance of OrderDetailResponseServiceresponseOrderdetailresponseShiptoaddress', function() {
      ...
      //var instance = new XiSdkResellers.OrderDetailResponseServiceresponseOrderdetailresponseShiptoaddress();
      //expect(instance).to.be.a(XiSdkResellers.OrderDetailResponseServiceresponseOrderdetailresponseShiptoaddress);
    });
