...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.QuoteDetailsResponseQuoteDetailResponse();
  });
  ...
  describe('QuoteDetailsResponseQuoteDetailResponse', function() {
    it('should create an instance of QuoteDetailsResponseQuoteDetailResponse', function() {
      ...
      //var instance = new ResellerApiDocumentation.QuoteDetailsResponseQuoteDetailResponse();
      //expect(instance).to.be.a(ResellerApiDocumentation.QuoteDetailsResponseQuoteDetailResponse);
    });
