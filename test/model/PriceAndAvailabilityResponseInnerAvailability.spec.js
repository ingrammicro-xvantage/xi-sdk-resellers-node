...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.PriceAndAvailabilityResponseInnerAvailability();
  });
  ...
  describe('PriceAndAvailabilityResponseInnerAvailability', function() {
    it('should create an instance of PriceAndAvailabilityResponseInnerAvailability', function() {
      ...
      //var instance = new ResellerApi.PriceAndAvailabilityResponseInnerAvailability();
      //expect(instance).to.be.a(ResellerApi.PriceAndAvailabilityResponseInnerAvailability);
    });
