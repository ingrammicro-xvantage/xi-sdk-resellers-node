...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner);
    });
