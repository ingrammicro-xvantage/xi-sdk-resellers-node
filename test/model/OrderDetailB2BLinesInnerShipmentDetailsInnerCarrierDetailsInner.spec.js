...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner();
  });
  ...
  describe('OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner', function() {
    it('should create an instance of OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner);
    });
