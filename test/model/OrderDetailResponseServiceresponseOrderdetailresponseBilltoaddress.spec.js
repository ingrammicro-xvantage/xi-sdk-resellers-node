...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.OrderDetailResponseServiceresponseOrderdetailresponseBilltoaddress();
  });
  ...
  describe('OrderDetailResponseServiceresponseOrderdetailresponseBilltoaddress', function() {
    it('should create an instance of OrderDetailResponseServiceresponseOrderdetailresponseBilltoaddress', function() {
      ...
      //var instance = new ResellerApi.OrderDetailResponseServiceresponseOrderdetailresponseBilltoaddress();
      //expect(instance).to.be.a(ResellerApi.OrderDetailResponseServiceresponseOrderdetailresponseBilltoaddress);
    });
