...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseServiceresponseOrdermodifyresponse();
  });
  ...
  describe('OrderModifyResponseServiceresponseOrdermodifyresponse', function() {
    it('should create an instance of OrderModifyResponseServiceresponseOrdermodifyresponse', function() {
      ...
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseServiceresponseOrdermodifyresponse();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyResponseServiceresponseOrdermodifyresponse);
    });
