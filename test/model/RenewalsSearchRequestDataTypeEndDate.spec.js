...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.RenewalsSearchRequestDataTypeEndDate();
  });
  ...
  describe('RenewalsSearchRequestDataTypeEndDate', function() {
    it('should create an instance of RenewalsSearchRequestDataTypeEndDate', function() {
      ...
      //var instance = new ResellerApi.RenewalsSearchRequestDataTypeEndDate();
      //expect(instance).to.be.a(ResellerApi.RenewalsSearchRequestDataTypeEndDate);
    });
