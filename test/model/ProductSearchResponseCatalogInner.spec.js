...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductSearchResponseCatalogInner();
  });
  ...
  describe('ProductSearchResponseCatalogInner', function() {
    it('should create an instance of ProductSearchResponseCatalogInner', function() {
      ...
      //var instance = new ResellerApi.ProductSearchResponseCatalogInner();
      //expect(instance).to.be.a(ResellerApi.ProductSearchResponseCatalogInner);
    });
