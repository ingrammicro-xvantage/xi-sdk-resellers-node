...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseShipToInfo();
  });
  ...
  describe('OrderModifyResponseShipToInfo', function() {
    it('should create an instance of OrderModifyResponseShipToInfo', function() {
      // uncomment below and update the code to test OrderModifyResponseShipToInfo
      //var instance = new ResellerApiDocumentationUnitedStates.OrderModifyResponseShipToInfo();
      //expect(instance).to.be.a(ResellerApiDocumentationUnitedStates.OrderModifyResponseShipToInfo);
    });
