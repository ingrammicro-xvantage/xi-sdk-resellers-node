...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ProductDetailResponseTechnicalSpecificationsInner();
  });
  ...
  describe('ProductDetailResponseTechnicalSpecificationsInner', function() {
    it('should create an instance of ProductDetailResponseTechnicalSpecificationsInner', function() {
      ...
      //var instance = new ResellerApi.ProductDetailResponseTechnicalSpecificationsInner();
      //expect(instance).to.be.a(ResellerApi.ProductDetailResponseTechnicalSpecificationsInner);
    });
