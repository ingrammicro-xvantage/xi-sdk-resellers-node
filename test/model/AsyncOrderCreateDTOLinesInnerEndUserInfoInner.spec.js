...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XiSdkResellers.AsyncOrderCreateDTOLinesInnerEndUserInfoInner();
  });
  ...
  describe('AsyncOrderCreateDTOLinesInnerEndUserInfoInner', function() {
    it('should create an instance of AsyncOrderCreateDTOLinesInnerEndUserInfoInner', function() {
      // uncomment below and update the code to test AsyncOrderCreateDTOLinesInnerEndUserInfoInner
      //var instance = new XiSdkResellers.AsyncOrderCreateDTOLinesInnerEndUserInfoInner();
      //expect(instance).to.be.a(XiSdkResellers.AsyncOrderCreateDTOLinesInnerEndUserInfoInner);
    });
