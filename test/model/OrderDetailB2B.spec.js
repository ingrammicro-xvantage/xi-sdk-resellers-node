...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApiDocumentation.OrderDetailB2B();
  });
  ...
  describe('OrderDetailB2B', function() {
    it('should create an instance of OrderDetailB2B', function() {
      ...
      //var instance = new ResellerApiDocumentation.OrderDetailB2B();
      //expect(instance).to.be.a(ResellerApiDocumentation.OrderDetailB2B);
    });
