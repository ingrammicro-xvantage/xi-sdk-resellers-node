...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse();
  });
  ...
  describe('MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse', function() {
    it('should create an instance of MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse', function() {
      ...
      //var instance = new ResellerApi.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse();
      //expect(instance).to.be.a(ResellerApi.MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse);
    });
