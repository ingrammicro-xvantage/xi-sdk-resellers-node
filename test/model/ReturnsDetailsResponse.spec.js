...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResellerApi.ReturnsDetailsResponse();
  });
  ...
  describe('ReturnsDetailsResponse', function() {
    it('should create an instance of ReturnsDetailsResponse', function() {
      ...
      //var instance = new ResellerApi.ReturnsDetailsResponse();
      //expect(instance).to.be.a(ResellerApi.ReturnsDetailsResponse);
    });
