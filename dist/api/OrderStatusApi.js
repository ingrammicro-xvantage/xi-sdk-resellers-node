...
* @version 1.0.0
*/
var OrderStatusApi = exports["default"] = /*#__PURE__*/function () {
  /**
  ...
  */
  ...
  _createClass(OrderStatusApi, [{
    key: "resellersV1WebhooksOrderstatuseventPost",
    value: function resellersV1WebhooksOrderstatuseventPost(targeturl, xHubSignature, orderStatusAsyncNotificationRequest, callback) {
      var postBody = orderStatusAsyncNotificationRequest;
      ...
      var accepts = [];
      var returnType = null;
      return this.apiClient.callApi('/resellers/v1/webhooks/orderstatusevent', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
  }]);
