...
* @version 1.0.0
*/
var OrdersV5Api = exports["default"] = /*#__PURE__*/function () {
  /**
  ...
  */
  function OrdersV5Api(apiClient) {
    _classCallCheck(this, OrdersV5Api);
   ...
   */
  _createClass(OrdersV5Api, [{
    key: "deleteOrdersOrderNumber",
    value: function deleteOrdersOrderNumber(ordernumber, customerNumber, isoCountryCode, entryDate, callback) {
      var postBody = null;
      ...
      var returnType = _OrderCancelResponse["default"];
      return this.apiClient.callApi('/resellers/v5/Orders/{ordernumber}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "getOrdersSearch",
    value: function getOrdersSearch(customerNumber, isocountrycode, opts, callback) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'customerNumber' is set
      if (customerNumber === undefined || customerNumber === null) {
      ...
      return this.apiClient.callApi('/resellers/v5/Orders/search', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "getV5OrdersDetails",
    value: function getV5OrdersDetails(ordernumber, customernumber, isocountrycode, opts, callback) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'ordernumber' is set
      if (ordernumber === undefined || ordernumber === null) {
      ...
      return this.apiClient.callApi('/resellers/v5/Orders/{ordernumber}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "postV5OrdersCreate",
    value: function postV5OrdersCreate(opts, callback) {
      opts = opts || {};
      ...
      return this.apiClient.callApi('/resellers/v5/Orders', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
  }]);
  return OrdersV5Api;
}();