...
var _OrderModifyRequestServicerequestOrdermodifyrequest = _interopRequireDefault(require("./OrderModifyRequestServicerequestOrdermodifyrequest"));
var _OrderModifyRequestServicerequestRequestpreamble = _interopRequireDefault(require("./OrderModifyRequestServicerequestRequestpreamble"));
 ...
 * @version 1.0.0
 */
var OrderModifyRequestServicerequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderModifyRequestServicerequest</code>.
   * @alias module:model/OrderModifyRequestServicerequest
   */
  function OrderModifyRequestServicerequest() {
    _classCallCheck(this, OrderModifyRequestServicerequest);
   ...
   */
  _createClass(OrderModifyRequestServicerequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('requestpreamble')) {
          obj['requestpreamble'] = _OrderModifyRequestServicerequestRequestpreamble["default"].constructFromObject(data['requestpreamble']);
        }
        if (data.hasOwnProperty('ordermodifyrequest')) {
          obj['ordermodifyrequest'] = _OrderModifyRequestServicerequestOrdermodifyrequest["default"].constructFromObject(data['ordermodifyrequest']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['requestpreamble']) {
        // data not null
        _OrderModifyRequestServicerequestRequestpreamble["default"].validateJSON(data['requestpreamble']);
      }
      // validate the optional field `ordermodifyrequest`
      if (data['ordermodifyrequest']) {
        // data not null
        _OrderModifyRequestServicerequestOrdermodifyrequest["default"].validateJSON(data['ordermodifyrequest']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OrderModifyRequestServicerequest;