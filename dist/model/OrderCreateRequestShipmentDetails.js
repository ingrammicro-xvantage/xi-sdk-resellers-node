 ...
 * @version 1.0.0
 */
var OrderCreateRequestShipmentDetails = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrderCreateRequestShipmentDetails() {
    _classCallCheck(this, OrderCreateRequestShipmentDetails);
   ...
   */
  _createClass(OrderCreateRequestShipmentDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('shipComplete')) {
          obj['shipComplete'] = _ApiClient["default"].convertToType(data['shipComplete'], 'String');
        }
        ...
        if (data.hasOwnProperty('signatureRequired')) {
          obj['signatureRequired'] = _ApiClient["default"].convertToType(data['signatureRequired'], 'Boolean');
        }
...
var _default = exports["default"] = OrderCreateRequestShipmentDetails;