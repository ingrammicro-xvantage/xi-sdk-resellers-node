...
var _PriceAndAvailabilityRequestServicerequestPriceandstockrequest = _interopRequireDefault(require("./PriceAndAvailabilityRequestServicerequestPriceandstockrequest"));
var _PriceAndAvailabilityRequestServicerequestRequestpreamble = _interopRequireDefault(require("./PriceAndAvailabilityRequestServicerequestRequestpreamble"));
 ...
 * @version 1.0.0
 */
var PriceAndAvailabilityRequestServicerequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function PriceAndAvailabilityRequestServicerequest() {
    _classCallCheck(this, PriceAndAvailabilityRequestServicerequest);
   ...
   */
  _createClass(PriceAndAvailabilityRequestServicerequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('requestpreamble')) {
          obj['requestpreamble'] = _PriceAndAvailabilityRequestServicerequestRequestpreamble["default"].constructFromObject(data['requestpreamble']);
        }
        if (data.hasOwnProperty('priceandstockrequest')) {
          obj['priceandstockrequest'] = _PriceAndAvailabilityRequestServicerequestPriceandstockrequest["default"].constructFromObject(data['priceandstockrequest']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['requestpreamble']) {
        // data not null
        _PriceAndAvailabilityRequestServicerequestRequestpreamble["default"].validateJSON(data['requestpreamble']);
      }
      // validate the optional field `priceandstockrequest`
      if (data['priceandstockrequest']) {
        // data not null
        _PriceAndAvailabilityRequestServicerequestPriceandstockrequest["default"].validateJSON(data['priceandstockrequest']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = PriceAndAvailabilityRequestServicerequest;