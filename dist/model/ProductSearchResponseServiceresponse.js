...
var _ProductSearchResponseServiceresponseProductsearchresponseInner = _interopRequireDefault(require("./ProductSearchResponseServiceresponseProductsearchresponseInner"));
var _ProductSearchResponseServiceresponseResponsepreamble = _interopRequireDefault(require("./ProductSearchResponseServiceresponseResponsepreamble"));
 ...
 * @version 1.0.0
 */
var ProductSearchResponseServiceresponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ProductSearchResponseServiceresponse</code>.
   * @alias module:model/ProductSearchResponseServiceresponse
   */
  function ProductSearchResponseServiceresponse() {
    _classCallCheck(this, ProductSearchResponseServiceresponse);
   ...
   */
  _createClass(ProductSearchResponseServiceresponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('responsepreamble')) {
          obj['responsepreamble'] = _ProductSearchResponseServiceresponseResponsepreamble["default"].constructFromObject(data['responsepreamble']);
        }
        if (data.hasOwnProperty('productsearchresponse')) {
          obj['productsearchresponse'] = _ApiClient["default"].convertToType(data['productsearchresponse'], [_ProductSearchResponseServiceresponseProductsearchresponseInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['responsepreamble']) {
        // data not null
        _ProductSearchResponseServiceresponseResponsepreamble["default"].validateJSON(data['responsepreamble']);
      }
      if (data['productsearchresponse']) {
        // data not null
        ...
        var _iterator = _createForOfIteratorHelper(data['productsearchresponse']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ProductSearchResponseServiceresponseProductsearchresponseInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ProductSearchResponseServiceresponse;