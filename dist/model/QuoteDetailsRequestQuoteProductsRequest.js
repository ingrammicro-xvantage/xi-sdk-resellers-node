...
var _QuoteDetailsRequestQuoteProductsRequestRequestpreamble = _interopRequireDefault(require("./QuoteDetailsRequestQuoteProductsRequestRequestpreamble"));
var _QuoteDetailsRequestQuoteProductsRequestRetrieveQuoteProductsRequest = _interopRequireDefault(require("./QuoteDetailsRequestQuoteProductsRequestRetrieveQuoteProductsRequest"));
 ...
 * @version 1.0.0
 */
var QuoteDetailsRequestQuoteProductsRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function QuoteDetailsRequestQuoteProductsRequest() {
    _classCallCheck(this, QuoteDetailsRequestQuoteProductsRequest);
   ...
   */
  _createClass(QuoteDetailsRequestQuoteProductsRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('requestpreamble')) {
          obj['requestpreamble'] = _QuoteDetailsRequestQuoteProductsRequestRequestpreamble["default"].constructFromObject(data['requestpreamble']);
        }
        if (data.hasOwnProperty('retrieveQuoteProductsRequest')) {
          obj['retrieveQuoteProductsRequest'] = _QuoteDetailsRequestQuoteProductsRequestRetrieveQuoteProductsRequest["default"].constructFromObject(data['retrieveQuoteProductsRequest']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['requestpreamble']) {
        // data not null
        _QuoteDetailsRequestQuoteProductsRequestRequestpreamble["default"].validateJSON(data['requestpreamble']);
      }
      // validate the optional field `retrieveQuoteProductsRequest`
      if (data['retrieveQuoteProductsRequest']) {
        // data not null
        _QuoteDetailsRequestQuoteProductsRequestRetrieveQuoteProductsRequest["default"].validateJSON(data['retrieveQuoteProductsRequest']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = QuoteDetailsRequestQuoteProductsRequest;