...
var _ProductSearchRequestServicerequest = _interopRequireDefault(require("./ProductSearchRequestServicerequest"));
 ...
 * @version 1.0.0
 */
var ProductSearchRequest = /*#__PURE__*/function () {
  /**
  ...
  function ProductSearchRequest() {
    _classCallCheck(this, ProductSearchRequest);
   ...
   */
  _createClass(ProductSearchRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('servicerequest')) {
          obj['servicerequest'] = _ProductSearchRequestServicerequest["default"].constructFromObject(data['servicerequest']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['servicerequest']) {
        // data not null
        _ProductSearchRequestServicerequest["default"].validateJSON(data['servicerequest']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = ProductSearchRequest;