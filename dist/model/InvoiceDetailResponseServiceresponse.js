...
var _InvoiceDetailResponseServiceresponseInvoicedetailresponse = _interopRequireDefault(require("./InvoiceDetailResponseServiceresponseInvoicedetailresponse"));
 ...
 * @version 1.0.0
 */
var InvoiceDetailResponseServiceresponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>InvoiceDetailResponseServiceresponse</code>.
   * @alias module:model/InvoiceDetailResponseServiceresponse
   */
  function InvoiceDetailResponseServiceresponse() {
    _classCallCheck(this, InvoiceDetailResponseServiceresponse);
   ...
   */
  _createClass(InvoiceDetailResponseServiceresponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('invoicedetailresponse')) {
          obj['invoicedetailresponse'] = _InvoiceDetailResponseServiceresponseInvoicedetailresponse["default"].constructFromObject(data['invoicedetailresponse']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['invoicedetailresponse']) {
        // data not null
        _InvoiceDetailResponseServiceresponseInvoicedetailresponse["default"].validateJSON(data['invoicedetailresponse']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = InvoiceDetailResponseServiceresponse;