...
var _OrderCancelResponseServiceresponseResponsepreamble = _interopRequireDefault(require("./OrderCancelResponseServiceresponseResponsepreamble"));
 ...
 * @version 1.0.0
 */
var OrderCancelResponseServiceresponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderCancelResponseServiceresponse</code>.
   * @alias module:model/OrderCancelResponseServiceresponse
   */
  function OrderCancelResponseServiceresponse() {
    _classCallCheck(this, OrderCancelResponseServiceresponse);
   ...
   */
  _createClass(OrderCancelResponseServiceresponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('responsepreamble')) {
          obj['responsepreamble'] = _OrderCancelResponseServiceresponseResponsepreamble["default"].constructFromObject(data['responsepreamble']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['responsepreamble']) {
        // data not null
        _OrderCancelResponseServiceresponseResponsepreamble["default"].validateJSON(data['responsepreamble']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OrderCancelResponseServiceresponse;