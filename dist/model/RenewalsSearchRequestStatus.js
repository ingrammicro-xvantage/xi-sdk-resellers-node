...
var _RenewalsSearchRequestStatusOpporutinyStatus = _interopRequireDefault(require("./RenewalsSearchRequestStatusOpporutinyStatus"));
 ...
 * @version 1.0.0
 */
var RenewalsSearchRequestStatus = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RenewalsSearchRequestStatus</code>.
   * @alias module:model/RenewalsSearchRequestStatus
   */
  function RenewalsSearchRequestStatus() {
    _classCallCheck(this, RenewalsSearchRequestStatus);
   ...
   */
  _createClass(RenewalsSearchRequestStatus, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('OpporutinyStatus')) {
          obj['OpporutinyStatus'] = _RenewalsSearchRequestStatusOpporutinyStatus["default"].constructFromObject(data['OpporutinyStatus']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['OpporutinyStatus']) {
        // data not null
        _RenewalsSearchRequestStatusOpporutinyStatus["default"].validateJSON(data['OpporutinyStatus']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = RenewalsSearchRequestStatus;