 ...
 */
/**
 * The OrderCreateRequestEndUserInfo model module.
 * @module model/OrderCreateRequestEndUserInfo
 * @version 1.0.0
 */
var OrderCreateRequestEndUserInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderCreateRequestEndUserInfo</code>.
   * The contact information for the end user/customer provided by the reseller. Used to determine pricing and discounts.
   * @alias module:model/OrderCreateRequestEndUserInfo
   */
  function OrderCreateRequestEndUserInfo() {
    _classCallCheck(this, OrderCreateRequestEndUserInfo);
    OrderCreateRequestEndUserInfo.initialize(this);
  }
   ...
   */
  _createClass(OrderCreateRequestEndUserInfo, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>OrderCreateRequestEndUserInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreateRequestEndUserInfo} obj Optional instance to populate.
     * @return {module:model/OrderCreateRequestEndUserInfo} The populated <code>OrderCreateRequestEndUserInfo</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OrderCreateRequestEndUserInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreateRequestEndUserInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreateRequestEndUserInfo</code>.
     */
  }, {
    key: "validateJSON",
 ...
 */
OrderCreateRequestEndUserInfo.prototype['endUserId'] = undefined;

/**
 * The contact name for the end user/customer.
 * @member {String} contact
 */
OrderCreateRequestEndUserInfo.prototype['contact'] = undefined;

/**
 * The company name for the end user/customer. Required for Impulse countries.
 * @member {String} companyName
 */
OrderCreateRequestEndUserInfo.prototype['companyName'] = undefined;

/**
 * name1
 * @member {String} name1
 */
OrderCreateRequestEndUserInfo.prototype['name1'] = undefined;

/**
 * name2
 * @member {String} name2
 */
OrderCreateRequestEndUserInfo.prototype['name2'] = undefined;

/**
 * The end user/customer's street address and building or house number. Required for Impulse countries.
 * @member {String} addressLine1
 */
OrderCreateRequestEndUserInfo.prototype['addressLine1'] = undefined;

/**
 * The end user/customer's apartment number.
 * @member {String} addressLine2
 */
OrderCreateRequestEndUserInfo.prototype['addressLine2'] = undefined;

/**
 * Line 3 of the address for the end user/customer.
 * @member {String} addressLine3
 */
OrderCreateRequestEndUserInfo.prototype['addressLine3'] = undefined;

/**
 * Street address4
 * @member {String} addressLine4
 */
OrderCreateRequestEndUserInfo.prototype['addressLine4'] = undefined;

/**
 * The end user/customer's city. Required for Impulse countries.
 * @member {String} city
 */
OrderCreateRequestEndUserInfo.prototype['city'] = undefined;

/**
 * The end user/customer's state. Required for Impulse countries but optional for EMEA countries.
 * @member {String} state
 */
OrderCreateRequestEndUserInfo.prototype['state'] = undefined;

/**
 * The end user/customer's zip or postal code. Required for Impulse countries.
 * @member {String} postalCode
 */
OrderCreateRequestEndUserInfo.prototype['postalCode'] = undefined;

/**
 * The end user/customer's two-character ISO country code.
 * @member {String} countryCode
 */
OrderCreateRequestEndUserInfo.prototype['countryCode'] = undefined;
 ...
 * @member {String} email
 */
OrderCreateRequestEndUserInfo.prototype['email'] = undefined;
var _default = exports["default"] = OrderCreateRequestEndUserInfo;