...
var _OrderSearchResponseOrdersInner = _interopRequireDefault(require("./OrderSearchResponseOrdersInner"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('orders')) {
          obj['orders'] = _ApiClient["default"].convertToType(data['orders'], [_OrderSearchResponseOrdersInner["default"]]);
        }
      ...
      if (data['orders']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _OrderSearchResponseOrdersInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
