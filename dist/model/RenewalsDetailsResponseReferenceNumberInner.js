 ...
 * @version 1.0.0
 */
var RenewalsDetailsResponseReferenceNumberInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function RenewalsDetailsResponseReferenceNumberInner() {
    _classCallCheck(this, RenewalsDetailsResponseReferenceNumberInner);
   ...
   */
  _createClass(RenewalsDetailsResponseReferenceNumberInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('notificationId')) {
          obj['notificationId'] = _ApiClient["default"].convertToType(data['notificationId'], 'String');
        }
...
var _default = exports["default"] = RenewalsDetailsResponseReferenceNumberInner;