 ...
 * @version 1.0.0
 */
var RenewalsSearchResponseRenewalsInner = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RenewalsSearchResponseRenewalsInner</code>.
   * @alias module:model/RenewalsSearchResponseRenewalsInner
   */
  function RenewalsSearchResponseRenewalsInner() {
    _classCallCheck(this, RenewalsSearchResponseRenewalsInner);
   ...
   */
  _createClass(RenewalsSearchResponseRenewalsInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('renewalValue')) {
          obj['renewalValue'] = _ApiClient["default"].convertToType(data['renewalValue'], 'String');
        }
        if (data.hasOwnProperty('status')) {
          obj['status'] = _ApiClient["default"].convertToType(data['status'], 'String');
        }
        if (data.hasOwnProperty('links')) {
          obj['links'] = _ApiClient["default"].convertToType(data['links'], [_RenewalsSearchResponseRenewalsInnerLinksInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['links']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RenewalsSearchResponseRenewalsInnerLinksInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = RenewalsSearchResponseRenewalsInner;