...
var _OrderDetailResponseBillToInfo = _interopRequireDefault(require("./OrderDetailResponseBillToInfo"));
var _OrderDetailResponseEndUserInfo = _interopRequireDefault(require("./OrderDetailResponseEndUserInfo"));
var _OrderDetailResponseLinesInner = _interopRequireDefault(require("./OrderDetailResponseLinesInner"));
...
var _OrderDetailResponseMiscellaneousChargesInner = _interopRequireDefault(require("./OrderDetailResponseMiscellaneousChargesInner"));
var _OrderDetailResponseShipToInfo = _interopRequireDefault(require("./OrderDetailResponseShipToInfo"));
 ...
 * @version 1.0.0
 */
var OrderDetailResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderDetailResponse</code>.
   * @alias module:model/OrderDetailResponse
   */
  function OrderDetailResponse() {
    _classCallCheck(this, OrderDetailResponse);
   ...
   */
  _createClass(OrderDetailResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('billToInfo')) {
          obj['billToInfo'] = _OrderDetailResponseBillToInfo["default"].constructFromObject(data['billToInfo']);
        }
        if (data.hasOwnProperty('shipToInfo')) {
          obj['shipToInfo'] = _OrderDetailResponseShipToInfo["default"].constructFromObject(data['shipToInfo']);
        }
        if (data.hasOwnProperty('endUserInfo')) {
          obj['endUserInfo'] = _OrderDetailResponseEndUserInfo["default"].constructFromObject(data['endUserInfo']);
        }
        if (data.hasOwnProperty('lines')) {
          obj['lines'] = _ApiClient["default"].convertToType(data['lines'], [_OrderDetailResponseLinesInner["default"]]);
        }
        if (data.hasOwnProperty('miscellaneousCharges')) {
          obj['miscellaneousCharges'] = _ApiClient["default"].convertToType(data['miscellaneousCharges'], [_OrderDetailResponseMiscellaneousChargesInner["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['billToInfo']) {
        // data not null
        _OrderDetailResponseBillToInfo["default"].validateJSON(data['billToInfo']);
      }
      // validate the optional field `shipToInfo`
      if (data['shipToInfo']) {
        // data not null
        _OrderDetailResponseShipToInfo["default"].validateJSON(data['shipToInfo']);
      }
      // validate the optional field `endUserInfo`
      if (data['endUserInfo']) {
        // data not null
        _OrderDetailResponseEndUserInfo["default"].validateJSON(data['endUserInfo']);
      }
      if (data['lines']) {
        // data not null
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _OrderDetailResponseLinesInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['miscellaneousCharges']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _OrderDetailResponseMiscellaneousChargesInner["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['additionalAttributes']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _OrderDetailResponseLinesInnerAdditionalAttributesInner["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
var _default = exports["default"] = OrderDetailResponse;