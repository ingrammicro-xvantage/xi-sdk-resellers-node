...
var _OrderModifyRequestServicerequest = _interopRequireDefault(require("./OrderModifyRequestServicerequest"));
 ...
 * @version 1.0.0
 */
var OrderModifyRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrderModifyRequest() {
    _classCallCheck(this, OrderModifyRequest);
   ...
   */
  _createClass(OrderModifyRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('servicerequest')) {
          obj['servicerequest'] = _OrderModifyRequestServicerequest["default"].constructFromObject(data['servicerequest']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['servicerequest']) {
        // data not null
        _OrderModifyRequestServicerequest["default"].validateJSON(data['servicerequest']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OrderModifyRequest;