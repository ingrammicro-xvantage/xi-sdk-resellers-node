 ...
 * @version 1.0.0
 */
var QuoteDetailsResponseProductsInnerPrice = /*#__PURE__*/function () {
  /**
   ...
   */
  function QuoteDetailsResponseProductsInnerPrice() {
    _classCallCheck(this, QuoteDetailsResponseProductsInnerPrice);
   ...
   */
  _createClass(QuoteDetailsResponseProductsInnerPrice, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('quotePrice')) {
          obj['quotePrice'] = _ApiClient["default"].convertToType(data['quotePrice'], 'Number');
        }
        ...
        if (data.hasOwnProperty('extendedQuotePrice')) {
          obj['extendedQuotePrice'] = _ApiClient["default"].convertToType(data['extendedQuotePrice'], 'Number');
        }
        if (data.hasOwnProperty('discountOffList')) {
          obj['discountOffList'] = _ApiClient["default"].convertToType(data['discountOffList'], 'Number');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = QuoteDetailsResponseProductsInnerPrice;