 ...
 */
/**
 * The OrderModifyRequestShipToInfo model module.
 * @module model/OrderModifyRequestShipToInfo
 * @version 1.0.0
 */
var OrderModifyRequestShipToInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderModifyRequestShipToInfo</code>.
   * The shipping information provided by the reseller.
   * @alias module:model/OrderModifyRequestShipToInfo
   */
  function OrderModifyRequestShipToInfo() {
    _classCallCheck(this, OrderModifyRequestShipToInfo);
    OrderModifyRequestShipToInfo.initialize(this);
  }
   ...
   */
  _createClass(OrderModifyRequestShipToInfo, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>OrderModifyRequestShipToInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderModifyRequestShipToInfo} obj Optional instance to populate.
     * @return {module:model/OrderModifyRequestShipToInfo} The populated <code>OrderModifyRequestShipToInfo</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OrderModifyRequestShipToInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderModifyRequestShipToInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderModifyRequestShipToInfo</code>.
     */
  }, {
    key: "validateJSON",
 ...
 */
OrderModifyRequestShipToInfo.prototype['addressId'] = undefined;

/**
 * The company contact provided by the reseller.
 * @member {String} contact
 */
OrderModifyRequestShipToInfo.prototype['contact'] = undefined;

/**
 * The name of the company the order will be shipped to.
 * @member {String} companyName
 */
OrderModifyRequestShipToInfo.prototype['companyName'] = undefined;

/**
 * name1.
 * @member {String} name1
 */
OrderModifyRequestShipToInfo.prototype['name1'] = undefined;

/**
 * name2.
 * @member {String} name2
 */
OrderModifyRequestShipToInfo.prototype['name2'] = undefined;

/**
 * The street address and building or house number the order will be shipped to.
 * @member {String} addressLine1
 */
OrderModifyRequestShipToInfo.prototype['addressLine1'] = undefined;

/**
 * The apartment number the order will be shipped to.
 * @member {String} addressLine2
 */
OrderModifyRequestShipToInfo.prototype['addressLine2'] = undefined;

/**
 * Line 3 of the address the order will be shipped to.
 * @member {String} addressLine3
 */
OrderModifyRequestShipToInfo.prototype['addressLine3'] = undefined;

/**
 * The city the order will be shipped to.
 * @member {String} city
 */
OrderModifyRequestShipToInfo.prototype['city'] = undefined;

/**
 * The state the order will be shipped to.
 * @member {String} state
 */
OrderModifyRequestShipToInfo.prototype['state'] = undefined;

/**
 * The zip or postal code the order will be shipped to.
 * @member {String} postalCode
 */
OrderModifyRequestShipToInfo.prototype['postalCode'] = undefined;

/**
 * The two-character ISO country code the order will be shipped to.
 * @member {String} countryCode
 */
OrderModifyRequestShipToInfo.prototype['countryCode'] = undefined;

/**
 * The company contact phone number.
 * @member {String} phoneNumber
 */
OrderModifyRequestShipToInfo.prototype['phoneNumber'] = undefined;

/**
 * The company contact email address.
 * @member {String} email
 */
OrderModifyRequestShipToInfo.prototype['email'] = undefined;
var _default = exports["default"] = OrderModifyRequestShipToInfo;