...
var _OrderModifyResponseServiceresponse = _interopRequireDefault(require("./OrderModifyResponseServiceresponse"));
 ...
 * @version 1.0.0
 */
var OrderModifyResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrderModifyResponse() {
    _classCallCheck(this, OrderModifyResponse);
   ...
   */
  _createClass(OrderModifyResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('serviceresponse')) {
          obj['serviceresponse'] = _OrderModifyResponseServiceresponse["default"].constructFromObject(data['serviceresponse']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['serviceresponse']) {
        // data not null
        _OrderModifyResponseServiceresponse["default"].validateJSON(data['serviceresponse']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OrderModifyResponse;