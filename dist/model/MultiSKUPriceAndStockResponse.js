...
var _MultiSKUPriceAndStockResponseServiceresponse = _interopRequireDefault(require("./MultiSKUPriceAndStockResponseServiceresponse"));
 ...
 * @version 1.0.0
 */
var MultiSKUPriceAndStockResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function MultiSKUPriceAndStockResponse() {
    _classCallCheck(this, MultiSKUPriceAndStockResponse);
   ...
   */
  _createClass(MultiSKUPriceAndStockResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('serviceresponse')) {
          obj['serviceresponse'] = _MultiSKUPriceAndStockResponseServiceresponse["default"].constructFromObject(data['serviceresponse']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['serviceresponse']) {
        // data not null
        _MultiSKUPriceAndStockResponseServiceresponse["default"].validateJSON(data['serviceresponse']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = MultiSKUPriceAndStockResponse;