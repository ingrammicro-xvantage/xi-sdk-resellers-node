...
var _PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner = _interopRequireDefault(require("./PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner"));
var _PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner = _interopRequireDefault(require("./PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner"));
 ...
 * @version 1.0.0
 */
var PriceAndAvailabilityResponseInnerDiscountsInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function PriceAndAvailabilityResponseInnerDiscountsInner() {
    _classCallCheck(this, PriceAndAvailabilityResponseInnerDiscountsInner);
   ...
   */
  _createClass(PriceAndAvailabilityResponseInnerDiscountsInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('specialPricing')) {
          obj['specialPricing'] = _ApiClient["default"].convertToType(data['specialPricing'], [_PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner["default"]]);
        }
        if (data.hasOwnProperty('quantityDiscounts')) {
          obj['quantityDiscounts'] = _ApiClient["default"].convertToType(data['quantityDiscounts'], [_PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['specialPricing']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['specialPricing']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['quantityDiscounts']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['quantityDiscounts']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = PriceAndAvailabilityResponseInnerDiscountsInner;