...
var _FreightResponseFreightEstimateResponseDistributionInnerCarrierListInner = _interopRequireDefault(require("./FreightResponseFreightEstimateResponseDistributionInnerCarrierListInner"));
 ...
 * @version 1.0.0
 */
var FreightResponseFreightEstimateResponseDistributionInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function FreightResponseFreightEstimateResponseDistributionInner() {
    _classCallCheck(this, FreightResponseFreightEstimateResponseDistributionInner);
   ...
   */
  _createClass(FreightResponseFreightEstimateResponseDistributionInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('shipFromBranchNumber')) {
          obj['shipFromBranchNumber'] = _ApiClient["default"].convertToType(data['shipFromBranchNumber'], 'String');
        }
        ...
        if (data.hasOwnProperty('freightRate')) {
          obj['freightRate'] = _ApiClient["default"].convertToType(data['freightRate'], 'Number');
        }
        ...
        if (data.hasOwnProperty('transitDays')) {
          obj['transitDays'] = _ApiClient["default"].convertToType(data['transitDays'], 'Number');
        }
        if (data.hasOwnProperty('carrierList')) {
          obj['carrierList'] = _ApiClient["default"].convertToType(data['carrierList'], [_FreightResponseFreightEstimateResponseDistributionInnerCarrierListInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['carrierList']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['carrierList']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _FreightResponseFreightEstimateResponseDistributionInnerCarrierListInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = FreightResponseFreightEstimateResponseDistributionInner;