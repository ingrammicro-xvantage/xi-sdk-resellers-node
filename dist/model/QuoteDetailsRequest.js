...
var _QuoteDetailsRequestQuoteProductsRequest = _interopRequireDefault(require("./QuoteDetailsRequestQuoteProductsRequest"));
 ...
 * @version 1.0.0
 */
var QuoteDetailsRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function QuoteDetailsRequest() {
    _classCallCheck(this, QuoteDetailsRequest);
   ...
   */
  _createClass(QuoteDetailsRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('quoteProductsRequest')) {
          obj['quoteProductsRequest'] = _QuoteDetailsRequestQuoteProductsRequest["default"].constructFromObject(data['quoteProductsRequest']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['quoteProductsRequest']) {
        // data not null
        _QuoteDetailsRequestQuoteProductsRequest["default"].validateJSON(data['quoteProductsRequest']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = QuoteDetailsRequest;