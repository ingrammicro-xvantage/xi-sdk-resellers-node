...
var _PriceAndAvailabilityResponseInnerAvailabilityAvailabilityByWarehouseInner = _interopRequireDefault(require("./PriceAndAvailabilityResponseInnerAvailabilityAvailabilityByWarehouseInner"));
 ...
 * @version 1.0.0
 */
var PriceAndAvailabilityResponseInnerAvailability = /*#__PURE__*/function () {
  /**
   ...
   */
  function PriceAndAvailabilityResponseInnerAvailability() {
    _classCallCheck(this, PriceAndAvailabilityResponseInnerAvailability);
   ...
   */
  _createClass(PriceAndAvailabilityResponseInnerAvailability, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('totalAvailability')) {
          obj['totalAvailability'] = _ApiClient["default"].convertToType(data['totalAvailability'], 'Number');
        }
        if (data.hasOwnProperty('availabilityByWarehouse')) {
          obj['availabilityByWarehouse'] = _ApiClient["default"].convertToType(data['availabilityByWarehouse'], [_PriceAndAvailabilityResponseInnerAvailabilityAvailabilityByWarehouseInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['availabilityByWarehouse']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _PriceAndAvailabilityResponseInnerAvailabilityAvailabilityByWarehouseInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = PriceAndAvailabilityResponseInnerAvailability;