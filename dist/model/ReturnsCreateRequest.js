...
var _ReturnsCreateRequestListInner = _interopRequireDefault(require("./ReturnsCreateRequestListInner"));
 ...
 * @version 1.0.0
 */
var ReturnsCreateRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ReturnsCreateRequest</code>.
   * @alias module:model/ReturnsCreateRequest
   */
  function ReturnsCreateRequest() {
    _classCallCheck(this, ReturnsCreateRequest);
   ...
   */
  _createClass(ReturnsCreateRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('list')) {
          obj['list'] = _ApiClient["default"].convertToType(data['list'], [_ReturnsCreateRequestListInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['list']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ReturnsCreateRequestListInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ReturnsCreateRequest;