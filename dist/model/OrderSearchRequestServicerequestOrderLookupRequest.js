...
var _OrderSearchRequestServicerequestOrderLookupRequestCustomerOrderNumber = _interopRequireDefault(require("./OrderSearchRequestServicerequestOrderLookupRequestCustomerOrderNumber"));
var _OrderSearchRequestServicerequestOrderLookupRequestOrderNumber = _interopRequireDefault(require("./OrderSearchRequestServicerequestOrderLookupRequestOrderNumber"));
 ...
 * @version 1.0.0
 */
var OrderSearchRequestServicerequestOrderLookupRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrderSearchRequestServicerequestOrderLookupRequest() {
    _classCallCheck(this, OrderSearchRequestServicerequestOrderLookupRequest);
   ...
   */
  _createClass(OrderSearchRequestServicerequestOrderLookupRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('orderNumber')) {
          obj['orderNumber'] = _OrderSearchRequestServicerequestOrderLookupRequestOrderNumber["default"].constructFromObject(data['orderNumber']);
        }
        if (data.hasOwnProperty('customerOrderNumber')) {
          obj['customerOrderNumber'] = _OrderSearchRequestServicerequestOrderLookupRequestCustomerOrderNumber["default"].constructFromObject(data['customerOrderNumber']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['orderNumber']) {
        // data not null
        _OrderSearchRequestServicerequestOrderLookupRequestOrderNumber["default"].validateJSON(data['orderNumber']);
      }
      // validate the optional field `customerOrderNumber`
      if (data['customerOrderNumber']) {
        // data not null
        _OrderSearchRequestServicerequestOrderLookupRequestCustomerOrderNumber["default"].validateJSON(data['customerOrderNumber']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OrderSearchRequestServicerequestOrderLookupRequest;