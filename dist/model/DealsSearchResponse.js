...
var _DealsSearchResponseDealsInner = _interopRequireDefault(require("./DealsSearchResponseDealsInner"));
 ...
 * @version 1.0.0
 */
var DealsSearchResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DealsSearchResponse</code>.
   * @alias module:model/DealsSearchResponse
   */
  function DealsSearchResponse() {
    _classCallCheck(this, DealsSearchResponse);
   ...
   */
  _createClass(DealsSearchResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('deals')) {
          obj['deals'] = _ApiClient["default"].convertToType(data['deals'], [_DealsSearchResponseDealsInner["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['deals']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['deals']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _DealsSearchResponseDealsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = DealsSearchResponse;