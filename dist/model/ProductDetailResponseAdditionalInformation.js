...
var _ProductDetailResponseAdditionalInformationProductWeightInner = _interopRequireDefault(require("./ProductDetailResponseAdditionalInformationProductWeightInner"));
 ...
 * @version 1.0.0
 */
var ProductDetailResponseAdditionalInformation = /*#__PURE__*/function () {
  /**
   ...
   */
  function ProductDetailResponseAdditionalInformation() {
    _classCallCheck(this, ProductDetailResponseAdditionalInformation);
   ...
   */
  _createClass(ProductDetailResponseAdditionalInformation, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('productWeight')) {
          obj['productWeight'] = _ApiClient["default"].convertToType(data['productWeight'], [_ProductDetailResponseAdditionalInformationProductWeightInner["default"]]);
        }
        if (data.hasOwnProperty('isBulkFreight')) {
          obj['isBulkFreight'] = _ApiClient["default"].convertToType(data['isBulkFreight'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('length')) {
          obj['length'] = _ApiClient["default"].convertToType(data['length'], 'String');
        }
        if (data.hasOwnProperty('netWeight')) {
          obj['netWeight'] = _ApiClient["default"].convertToType(data['netWeight'], 'String');
        }
        if (data.hasOwnProperty('dimensionUnit')) {
          obj['dimensionUnit'] = _ApiClient["default"].convertToType(data['dimensionUnit'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['productWeight']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['productWeight']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ProductDetailResponseAdditionalInformationProductWeightInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ProductDetailResponseAdditionalInformation;