 ...
 * @version 1.0.0
 */
var QuoteToOrderResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>QuoteToOrderResponse</code>.
   * @alias module:model/QuoteToOrderResponse
   */
  function QuoteToOrderResponse() {
    _classCallCheck(this, QuoteToOrderResponse);
   ...
   */
  _createClass(QuoteToOrderResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('confirmationNumber')) {
          obj['confirmationNumber'] = _ApiClient["default"].convertToType(data['confirmationNumber'], 'Number');
        }
...
var _default = exports["default"] = QuoteToOrderResponse;