...
var _OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInnerPackageDetailsInner = _interopRequireDefault(require("./OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInnerPackageDetailsInner"));
 ...
 * @version 1.0.0
 */
var OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInner() {
    _classCallCheck(this, OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInner);
   ...
   */
  _createClass(OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('packageDetails')) {
          obj['packageDetails'] = _ApiClient["default"].convertToType(data['packageDetails'], [_OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInnerPackageDetailsInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['packageDetails']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['packageDetails']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInnerPackageDetailsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInner;