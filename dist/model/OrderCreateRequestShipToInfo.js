 ...
 */
/**
 * The OrderCreateRequestShipToInfo model module.
 * @module model/OrderCreateRequestShipToInfo
 * @version 1.0.0
 */
var OrderCreateRequestShipToInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderCreateRequestShipToInfo</code>.
   * The shipping information provided by the reseller.
   * @alias module:model/OrderCreateRequestShipToInfo
   */
  function OrderCreateRequestShipToInfo() {
    _classCallCheck(this, OrderCreateRequestShipToInfo);
    OrderCreateRequestShipToInfo.initialize(this);
  }
   ...
   */
  _createClass(OrderCreateRequestShipToInfo, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>OrderCreateRequestShipToInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreateRequestShipToInfo} obj Optional instance to populate.
     * @return {module:model/OrderCreateRequestShipToInfo} The populated <code>OrderCreateRequestShipToInfo</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OrderCreateRequestShipToInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreateRequestShipToInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreateRequestShipToInfo</code>.
     */
  }, {
    key: "validateJSON",
 ...
 */
OrderCreateRequestShipToInfo.prototype['addressId'] = undefined;

/**
 * The company contact provided by the reseller.
 * @member {String} contact
 */
OrderCreateRequestShipToInfo.prototype['contact'] = undefined;

/**
 * The name of the company the order will be shipped to.
 * @member {String} companyName
 */
OrderCreateRequestShipToInfo.prototype['companyName'] = undefined;

/**
 * name1
 * @member {String} name1
 */
OrderCreateRequestShipToInfo.prototype['name1'] = undefined;

/**
 * name2
 * @member {String} name2
 */
OrderCreateRequestShipToInfo.prototype['name2'] = undefined;

/**
 * The street address and building or house number the order will be shipped to.
 * @member {String} addressLine1
 */
OrderCreateRequestShipToInfo.prototype['addressLine1'] = undefined;

/**
 * The apartment number the order will be shipped to.
 * @member {String} addressLine2
 */
OrderCreateRequestShipToInfo.prototype['addressLine2'] = undefined;

/**
 * Line 3 of the address the order will be shipped to.
 * @member {String} addressLine3
 */
OrderCreateRequestShipToInfo.prototype['addressLine3'] = undefined;

/**
 * Street address4
 * @member {String} addressLine4
 */
OrderCreateRequestShipToInfo.prototype['addressLine4'] = undefined;

/**
 * The city the order will be shipped to.
 * @member {String} city
 */
OrderCreateRequestShipToInfo.prototype['city'] = undefined;

/**
 * The state the order will be shipped to.
 * @member {String} state
 */
OrderCreateRequestShipToInfo.prototype['state'] = undefined;

/**
 * The zip or postal code the order will be shipped to.
 * @member {String} postalCode
 */
OrderCreateRequestShipToInfo.prototype['postalCode'] = undefined;

/**
 * The two-character ISO country code the order will be shipped to.
 * @member {String} countryCode
 */
OrderCreateRequestShipToInfo.prototype['countryCode'] = undefined;

/**
 * The company contact phone number.
 * @member {String} phoneNumber
 */
OrderCreateRequestShipToInfo.prototype['phoneNumber'] = undefined;

/**
 * The company contact email address.
 * @member {String} email
 */
OrderCreateRequestShipToInfo.prototype['email'] = undefined;
var _default = exports["default"] = OrderCreateRequestShipToInfo;