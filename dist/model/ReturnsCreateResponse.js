...
var _ReturnsCreateResponseReturnsClaimsInner = _interopRequireDefault(require("./ReturnsCreateResponseReturnsClaimsInner"));
 ...
 * @version 1.0.0
 */
var ReturnsCreateResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ReturnsCreateResponse</code>.
   * @alias module:model/ReturnsCreateResponse
   */
  function ReturnsCreateResponse() {
    _classCallCheck(this, ReturnsCreateResponse);
   ...
   */
  _createClass(ReturnsCreateResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('returnsClaims')) {
          obj['returnsClaims'] = _ApiClient["default"].convertToType(data['returnsClaims'], [_ReturnsCreateResponseReturnsClaimsInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['returnsClaims']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ReturnsCreateResponseReturnsClaimsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ReturnsCreateResponse;