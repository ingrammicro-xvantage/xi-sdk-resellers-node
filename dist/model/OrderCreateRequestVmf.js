 ...
 * @version 1.0.0
 */
var OrderCreateRequestVmf = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrderCreateRequestVmf() {
    _classCallCheck(this, OrderCreateRequestVmf);
   ...
   */
  _createClass(OrderCreateRequestVmf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vendAuthNumber')) {
          obj['vendAuthNumber'] = _ApiClient["default"].convertToType(data['vendAuthNumber'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = OrderCreateRequestVmf;