 ...
 * @version 1.0.0
 */
var ProductDetailResponseTechnicalSpecificationsInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function ProductDetailResponseTechnicalSpecificationsInner() {
    _classCallCheck(this, ProductDetailResponseTechnicalSpecificationsInner);
   ...
   */
  _createClass(ProductDetailResponseTechnicalSpecificationsInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('attributedisplay')) {
          obj['attributedisplay'] = _ApiClient["default"].convertToType(data['attributedisplay'], 'String');
        }
...
var _default = exports["default"] = ProductDetailResponseTechnicalSpecificationsInner;