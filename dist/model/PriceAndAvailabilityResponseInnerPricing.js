 ...
 * @version 1.0.0
 */
var PriceAndAvailabilityResponseInnerPricing = /*#__PURE__*/function () {
  /**
   ...
   */
  function PriceAndAvailabilityResponseInnerPricing() {
    _classCallCheck(this, PriceAndAvailabilityResponseInnerPricing);
   ...
   */
  _createClass(PriceAndAvailabilityResponseInnerPricing, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mapPrice')) {
          obj['mapPrice'] = _ApiClient["default"].convertToType(data['mapPrice'], 'Number');
        }
        ...
        if (data.hasOwnProperty('specialBidPricingAvailable')) {
          obj['specialBidPricingAvailable'] = _ApiClient["default"].convertToType(data['specialBidPricingAvailable'], 'Boolean');
        }
        if (data.hasOwnProperty('webDiscountsAvailable')) {
          obj['webDiscountsAvailable'] = _ApiClient["default"].convertToType(data['webDiscountsAvailable'], 'Boolean');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = PriceAndAvailabilityResponseInnerPricing;