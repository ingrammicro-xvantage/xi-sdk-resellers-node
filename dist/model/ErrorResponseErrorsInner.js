...
var _ErrorResponseErrorsInnerFieldsInner = _interopRequireDefault(require("./ErrorResponseErrorsInnerFieldsInner"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fields')) {
          obj['fields'] = _ApiClient["default"].convertToType(data['fields'], [_ErrorResponseErrorsInnerFieldsInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['fields']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ErrorResponseErrorsInnerFieldsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ErrorResponseErrorsInner;