 ...
 */
/**
 * The OrderDetailB2BBillToInfo model module.
 * @module model/OrderDetailB2BBillToInfo
 * @version 1.0.0
 */
var OrderDetailB2BBillToInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderDetailB2BBillToInfo</code>.
   * The billing information provided by the reseller.
   * @alias module:model/OrderDetailB2BBillToInfo
   */
  function OrderDetailB2BBillToInfo() {
    _classCallCheck(this, OrderDetailB2BBillToInfo);
    OrderDetailB2BBillToInfo.initialize(this);
  }
   ...
   */
  _createClass(OrderDetailB2BBillToInfo, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>OrderDetailB2BBillToInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderDetailB2BBillToInfo} obj Optional instance to populate.
     * @return {module:model/OrderDetailB2BBillToInfo} The populated <code>OrderDetailB2BBillToInfo</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OrderDetailB2BBillToInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderDetailB2BBillToInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderDetailB2BBillToInfo</code>.
     */
  }, {
    key: "validateJSON",
 ...
 */
OrderDetailB2BBillToInfo.prototype['contact'] = undefined;

/**
 * The name of the company the order will be billed to.
 * @member {String} companyName
 */
OrderDetailB2BBillToInfo.prototype['companyName'] = undefined;

/**
 * The address line 1 the order will be billed to.
 * @member {String} addressLine1
 */
OrderDetailB2BBillToInfo.prototype['addressLine1'] = undefined;

/**
 * The address line 2 the order will be billed to.
 * @member {String} addressLine2
 */
OrderDetailB2BBillToInfo.prototype['addressLine2'] = undefined;

/**
 * The address line 3 the order will be billed to.
 * @member {String} addressLine3
 */
OrderDetailB2BBillToInfo.prototype['addressLine3'] = undefined;

/**
 * The city the order will be billed to.
 * @member {String} city
 */
OrderDetailB2BBillToInfo.prototype['city'] = undefined;

/**
 * The state the order will be billed to.
 * @member {String} state
 */
OrderDetailB2BBillToInfo.prototype['state'] = undefined;

/**
 * The zip or postal code the order will be billed to.
 * @member {String} postalCode
 */
OrderDetailB2BBillToInfo.prototype['postalCode'] = undefined;

/**
 * The two-character ISO country code the order will be billed to.
 * @member {String} countryCode
 */
OrderDetailB2BBillToInfo.prototype['countryCode'] = undefined;

/**
 * The company contact phone number.
 * @member {String} phoneNumber
 */
OrderDetailB2BBillToInfo.prototype['phoneNumber'] = undefined;

/**
 * The company contact email address.
 * @member {String} email
 */
OrderDetailB2BBillToInfo.prototype['email'] = undefined;
var _default = exports["default"] = OrderDetailB2BBillToInfo;