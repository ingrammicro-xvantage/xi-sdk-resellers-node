...
var _PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner = _interopRequireDefault(require("./PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner"));
 ...
 * @version 1.0.0
 */
var PriceAndAvailabilityRequestServicerequestPriceandstockrequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function PriceAndAvailabilityRequestServicerequestPriceandstockrequest() {
    _classCallCheck(this, PriceAndAvailabilityRequestServicerequestPriceandstockrequest);
   ...
   */
  _createClass(PriceAndAvailabilityRequestServicerequestPriceandstockrequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('showwarehouseavailability')) {
          obj['showwarehouseavailability'] = _ApiClient["default"].convertToType(data['showwarehouseavailability'], 'String');
        }
        if (data.hasOwnProperty('extravailabilityflag')) {
          obj['extravailabilityflag'] = _ApiClient["default"].convertToType(data['extravailabilityflag'], 'String');
        }
        if (data.hasOwnProperty('includeallsystems')) {
          obj['includeallsystems'] = _ApiClient["default"].convertToType(data['includeallsystems'], 'Boolean');
        }
        if (data.hasOwnProperty('item')) {
          obj['item'] = _ApiClient["default"].convertToType(data['item'], [_PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['item']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['item']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _PriceAndAvailabilityRequestServicerequestPriceandstockrequestItemInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = PriceAndAvailabilityRequestServicerequestPriceandstockrequest;