...
var _AvailabilityAsyncNotificationRequestResourceInner = _interopRequireDefault(require("./AvailabilityAsyncNotificationRequestResourceInner"));
 ...
 * @version 1.0.0
 */
var AvailabilityAsyncNotificationRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AvailabilityAsyncNotificationRequest</code>.
   * @alias module:model/AvailabilityAsyncNotificationRequest
   */
  function AvailabilityAsyncNotificationRequest() {
    _classCallCheck(this, AvailabilityAsyncNotificationRequest);
   ...
   */
  _createClass(AvailabilityAsyncNotificationRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('resource')) {
          obj['resource'] = _ApiClient["default"].convertToType(data['resource'], [_AvailabilityAsyncNotificationRequestResourceInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['resource']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _AvailabilityAsyncNotificationRequestResourceInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = AvailabilityAsyncNotificationRequest;