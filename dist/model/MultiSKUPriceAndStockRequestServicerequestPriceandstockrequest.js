...
var _MultiSKUPriceAndStockRequestServicerequestPriceandstockrequestItem = _interopRequireDefault(require("./MultiSKUPriceAndStockRequestServicerequestPriceandstockrequestItem"));
 ...
 * @version 1.0.0
 */
var MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest() {
    _classCallCheck(this, MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest);
   ...
   */
  _createClass(MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _MultiSKUPriceAndStockRequestServicerequestPriceandstockrequestItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['item']) {
        // data not null
        _MultiSKUPriceAndStockRequestServicerequestPriceandstockrequestItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest;