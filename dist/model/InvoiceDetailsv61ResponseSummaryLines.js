 ...
 * @version 1.0.0
 */
var InvoiceDetailsv61ResponseSummaryLines = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>InvoiceDetailsv61ResponseSummaryLines</code>.
   * @alias module:model/InvoiceDetailsv61ResponseSummaryLines
   */
  function InvoiceDetailsv61ResponseSummaryLines() {
    _classCallCheck(this, InvoiceDetailsv61ResponseSummaryLines);
   ...
   */
  _createClass(InvoiceDetailsv61ResponseSummaryLines, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('productLineCount')) {
          obj['productLineCount'] = _ApiClient["default"].convertToType(data['productLineCount'], 'Number');
        }
        if (data.hasOwnProperty('productLineTotalQuantity')) {
          obj['productLineTotalQuantity'] = _ApiClient["default"].convertToType(data['productLineTotalQuantity'], 'Number');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = InvoiceDetailsv61ResponseSummaryLines;