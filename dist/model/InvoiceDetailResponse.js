...
var _InvoiceDetailResponseServiceresponse = _interopRequireDefault(require("./InvoiceDetailResponseServiceresponse"));
 ...
 * @version 1.0.0
 */
var InvoiceDetailResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>InvoiceDetailResponse</code>.
   * @alias module:model/InvoiceDetailResponse
   */
  function InvoiceDetailResponse() {
    _classCallCheck(this, InvoiceDetailResponse);
   ...
   */
  _createClass(InvoiceDetailResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('serviceresponse')) {
          obj['serviceresponse'] = _InvoiceDetailResponseServiceresponse["default"].constructFromObject(data['serviceresponse']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['serviceresponse']) {
        // data not null
        _InvoiceDetailResponseServiceresponse["default"].validateJSON(data['serviceresponse']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = InvoiceDetailResponse;