...
var _ProductSearchResponseServiceresponseProductsearchresponseInnerPartnumbersInner = _interopRequireDefault(require("./ProductSearchResponseServiceresponseProductsearchresponseInnerPartnumbersInner"));
 ...
 * @version 1.0.0
 */
var ProductSearchResponseServiceresponseProductsearchresponseInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function ProductSearchResponseServiceresponseProductsearchresponseInner() {
    _classCallCheck(this, ProductSearchResponseServiceresponseProductsearchresponseInner);
   ...
   */
  _createClass(ProductSearchResponseServiceresponseProductsearchresponseInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('partnumbers')) {
          obj['partnumbers'] = _ApiClient["default"].convertToType(data['partnumbers'], [_ProductSearchResponseServiceresponseProductsearchresponseInnerPartnumbersInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['partnumbers']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['partnumbers']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ProductSearchResponseServiceresponseProductsearchresponseInnerPartnumbersInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ProductSearchResponseServiceresponseProductsearchresponseInner;