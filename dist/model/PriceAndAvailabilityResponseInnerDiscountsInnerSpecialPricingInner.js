 ...
 * @version 1.0.0
 */
var PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner() {
    _classCallCheck(this, PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner);
   ...
   */
  _createClass(PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('specialBidNumer')) {
          obj['specialBidNumer'] = _ApiClient["default"].convertToType(data['specialBidNumer'], 'String');
        }
        if (data.hasOwnProperty('specialPricingDiscount')) {
          obj['specialPricingDiscount'] = _ApiClient["default"].convertToType(data['specialPricingDiscount'], 'Number');
        }
        if (data.hasOwnProperty('specialPricingEffectiveDate')) {
          obj['specialPricingEffectiveDate'] = _ApiClient["default"].convertToType(data['specialPricingEffectiveDate'], 'Date');
        }
        if (data.hasOwnProperty('specialPricingExpirationDate')) {
          obj['specialPricingExpirationDate'] = _ApiClient["default"].convertToType(data['specialPricingExpirationDate'], 'Date');
        }
        if (data.hasOwnProperty('specialPricingAvailableQuantity')) {
          obj['specialPricingAvailableQuantity'] = _ApiClient["default"].convertToType(data['specialPricingAvailableQuantity'], 'Number');
        }
        if (data.hasOwnProperty('specialPricingMinQuantity')) {
          obj['specialPricingMinQuantity'] = _ApiClient["default"].convertToType(data['specialPricingMinQuantity'], 'Number');
        }
        if (data.hasOwnProperty('governmentDiscountType')) {
          obj['governmentDiscountType'] = _ApiClient["default"].convertToType(data['governmentDiscountType'], 'String');
        }
        if (data.hasOwnProperty('governmentDiscountedCustomerPrice')) {
          obj['governmentDiscountedCustomerPrice'] = _ApiClient["default"].convertToType(data['governmentDiscountedCustomerPrice'], 'Number');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner;